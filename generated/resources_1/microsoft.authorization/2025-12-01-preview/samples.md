...
```bicep
resource exampleResource 'Microsoft.Authorization/policyAssignments@2025-12-01-preview' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Authorization/policyDefinitions@2025-12-01-preview' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Authorization/policyDefinitions/versions@2025-12-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.Authorization/policyExemptions@2025-12-01-preview' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Authorization/policySetDefinitions@2025-12-01-preview' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Authorization/policySetDefinitions/versions@2025-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'Policies to enforce low cost storage SKUs'
...
```bicep
resource exampleResource 'Microsoft.Authorization/variables@2025-12-01-preview' = {
  name: 'example'
  properties: {
    columns: [
      {
...
```bicep
resource exampleResource 'Microsoft.Authorization/variables/values@2025-12-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    values: [
