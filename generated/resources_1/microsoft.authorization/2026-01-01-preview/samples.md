...
```bicep
resource exampleResource 'Microsoft.Authorization/policyAssignments@2026-01-01-preview' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Authorization/policyDefinitions@2026-01-01-preview' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Authorization/policyDefinitions/versions@2026-01-01-preview' = {
...
Create or update a policy enrollment
```bicep
resource exampleResource 'Microsoft.Authorization/policyEnrollments@2026-01-01-preview' = {
  name: 'example'
  properties: {
...
Create or update a policy enrollment with resource selectors
```bicep
resource exampleResource 'Microsoft.Authorization/policyEnrollments@2026-01-01-preview' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Authorization/policyExemptions@2026-01-01-preview' = {
  name: 'example'
  properties: {
...
Create or update a policy exemption with exemption management mode
```bicep
resource exampleResource 'Microsoft.Authorization/policyExemptions@2026-01-01-preview' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Authorization/policySetDefinitions@2026-01-01-preview' = {
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Authorization/policySetDefinitions/versions@2026-01-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'Policies to enforce low cost storage SKUs'
...
```bicep
resource exampleResource 'Microsoft.Authorization/variables@2026-01-01-preview' = {
  name: 'example'
  properties: {
    columns: [
      {
...
```bicep
resource exampleResource 'Microsoft.Authorization/variables/values@2026-01-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    values: [
