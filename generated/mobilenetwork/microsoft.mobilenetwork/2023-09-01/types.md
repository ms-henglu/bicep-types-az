# Microsoft.MobileNetwork @ 2023-09-01

## Resource Microsoft.MobileNetwork/mobileNetworks@2023-09-01
...
## Resource Microsoft.MobileNetwork/mobileNetworks/dataNetworks@2023-09-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2023-09-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.MobileNetwork/mobileNetworks/services@2023-09-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2023-09-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.MobileNetwork/mobileNetworks/simPolicies@2023-09-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2023-09-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.MobileNetwork/mobileNetworks/sites@2023-09-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2023-09-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.MobileNetwork/mobileNetworks/slices@2023-09-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2023-09-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.MobileNetwork/packetCoreControlPlanes@2023-09-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2023-09-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.MobileNetwork/packetCoreControlPlanes/diagnosticsPackages@2023-09-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2023-09-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.MobileNetwork/packetCoreControlPlanes/packetCaptures@2023-09-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2023-09-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.MobileNetwork/packetCoreControlPlanes/packetCoreDataPlanes@2023-09-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2023-09-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.MobileNetwork/packetCoreControlPlanes/packetCoreDataPlanes/attachedDataNetworks@2023-09-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2023-09-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.MobileNetwork/packetCoreControlPlaneVersions@2023-09-01 (ReadOnly)
...
## Resource Microsoft.MobileNetwork/simGroups@2023-09-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2023-09-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.MobileNetwork/simGroups/sims@2023-09-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2023-09-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
* **percentComplete**: int: Percentage of the operation that is complete.
...
### Properties
* **azureKeyIdentifier**: int (Required): An identifier for the Azure SIM onboarding public key used for encrypted upload.
* **encryptedTransportKey**: string (Required): The transport key used for encrypting SIM credentials, encrypted using the SIM onboarding public key.
* **signedTransportKey**: string (Required): The encrypted transport key, signed using the SIM vendor private key.
* **sims**: [SimNameAndEncryptedProperties](#simnameandencryptedproperties)[] (Required): A list of SIMs to upload, with encrypted properties.
* **vendorKeyFingerprint**: string (Required): The fingerprint of the SIM vendor public key. The private counterpart is used for signing the encrypted transport key.
* **version**: int (Required): The upload file format version.
...
### Properties
* **id**: string (Required): Resource ID  of Azure Event Hub to send packet core events to.
* **reportingInterval**: int: The duration (in seconds) between UE usage reports.
...
### Properties
* **macroMmeGroupId**: int (Required): The macro network's MME group ID. This is where unknown UEs are sent to via NAS reroute.
...
* **controlPlaneAccessVirtualIpv4Addresses**: string[]: The virtual IP address(es) for the control plane on the access network in a High Availability (HA) system. In an HA deployment the access network router should be configured to anycast traffic for this address to the control plane access interfaces on the active and standby nodes. In non-HA system this list should be omitted or empty.
...
### Properties
* **id**: string (Required): Packet core control plane resource ID.
...
* **userPlaneAccessVirtualIpv4Addresses**: string[]: The virtual IP address(es) for the user plane on the access network in a High Availability (HA) system. In an HA deployment the access network router should be configured to forward traffic for this address to the control plane access interface on the active or standby node. In non-HA system this list should be omitted or empty.
...
## SimDeleteList
### Properties
* **sims**: string[] (Required): A list of SIM resource names to delete.
...
## SimUploadList
### Properties
* **sims**: [SimNameAndProperties](#simnameandproperties)[] (Required): A list of SIMs to upload.
