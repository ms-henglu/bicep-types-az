...
## Resource Microsoft.MobileNetwork/packetCoreControlPlanes/ues/extendedInformation@2024-04-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2024-04-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Function cloneSims (Microsoft.MobileNetwork/simGroups@2024-04-01)
* **Resource**: Microsoft.MobileNetwork/simGroups
* **ApiVersion**: 2024-04-01
* **Input**: [SimClone](#simclone)
* **Output**: [AsyncOperationStatus](#asyncoperationstatus)

## Function collectDiagnosticsPackage (Microsoft.MobileNetwork/packetCoreControlPlanes@2024-04-01)
...
## Function deletePacketCore (Microsoft.MobileNetwork/mobileNetworks/sites@2024-04-01)
* **Resource**: Microsoft.MobileNetwork/mobileNetworks/sites
* **ApiVersion**: 2024-04-01
* **Input**: [SiteDeletePacketCore](#sitedeletepacketcore)

## Function deleteSims (Microsoft.MobileNetwork/simGroups@2024-04-01)
* **Resource**: Microsoft.MobileNetwork/simGroups
* **ApiVersion**: 2024-04-01
...
## Function moveSims (Microsoft.MobileNetwork/simGroups@2024-04-01)
* **Resource**: Microsoft.MobileNetwork/simGroups
* **ApiVersion**: 2024-04-01
* **Input**: [SimMove](#simmove)
* **Output**: [AsyncOperationStatus](#asyncoperationstatus)

## Function reinstall (Microsoft.MobileNetwork/packetCoreControlPlanes@2024-04-01)
* **Resource**: Microsoft.MobileNetwork/packetCoreControlPlanes
* **ApiVersion**: 2024-04-01
* **Output**: [AsyncOperationStatus](#asyncoperationstatus)

## Function rollback (Microsoft.MobileNetwork/packetCoreControlPlanes@2024-04-01)
* **Resource**: Microsoft.MobileNetwork/packetCoreControlPlanes
* **ApiVersion**: 2024-04-01
* **Output**: [AsyncOperationStatus](#asyncoperationstatus)

## Function stop (Microsoft.MobileNetwork/packetCoreControlPlanes/packetCaptures@2024-04-01)
* **Resource**: Microsoft.MobileNetwork/packetCoreControlPlanes/packetCaptures
* **ApiVersion**: 2024-04-01
* **Output**: [AsyncOperationStatus](#asyncoperationstatus)

## Function uploadEncryptedSims (Microsoft.MobileNetwork/simGroups@2024-04-01)
* **Resource**: Microsoft.MobileNetwork/simGroups
* **ApiVersion**: 2024-04-01
* **Input**: [EncryptedSimUploadList](#encryptedsimuploadlist)
* **Output**: [AsyncOperationStatus](#asyncoperationstatus)

## Function uploadSims (Microsoft.MobileNetwork/simGroups@2024-04-01)
* **Resource**: Microsoft.MobileNetwork/simGroups
* **ApiVersion**: 2024-04-01
...
## SimClone
### Properties
* **sims**: (string {maxLength: 64, pattern: "^[a-zA-Z0-9][a-zA-Z0-9_-]*$"})[] {minLength: 1}: A list of SIM resource names to be cloned.
* **targetSimGroupId**: [SimGroupResourceId](#simgroupresourceid): The SIM Group where the SIMs should be cloned.
...
## SimGroupResourceId
### Properties
* **id**: string {pattern: "^/[sS][uU][bB][sS][cC][rR][iI][pP][tT][iI][oO][nN][sS]/[^/?#]+/[rR][eE][sS][oO][uU][rR][cC][eE][gG][rR][oO][uU][pP][sS]/[^/?#]+/[pP][rR][oO][vV][iI][dD][eE][rR][sS]/[mM][iI][cC][rR][oO][sS][oO][fF][tT]\.[mM][oO][bB][iI][lL][eE][nN][eE][tT][wW][oO][rR][kK]/[sS][iI][mM][gG][rR][oO][uU][pP][sS]/[^/?#]+$"} (Required): SIM group resource ID.

## SimMove
### Properties
* **sims**: (string {maxLength: 64, pattern: "^[a-zA-Z0-9][a-zA-Z0-9_-]*$"})[] {minLength: 1}: A list of SIM resource names to be moved.
* **targetSimGroupId**: [SimGroupResourceId](#simgroupresourceid): The SIM Group where the SIMs should be moved.
