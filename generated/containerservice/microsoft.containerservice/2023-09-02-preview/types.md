# Microsoft.ContainerService @ 2023-09-02-preview

## Resource Microsoft.ContainerService/locations/guardrailsVersions@2023-09-02-preview (ReadOnly)
* **Valid Scope(s)**: Subscription
### Properties
* **apiVersion**: '2023-09-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.ContainerService/locations/meshRevisionProfiles@2023-09-02-preview (ReadOnly)
* **Valid Scope(s)**: Subscription
### Properties
* **apiVersion**: '2023-09-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerService/managedClusters@2023-09-02-preview
...
## Resource Microsoft.ContainerService/managedClusters/agentPools@2023-09-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2023-09-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerService/managedClusters/agentPools/machines@2023-09-02-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2023-09-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerService/managedClusters/maintenanceConfigurations@2023-09-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2023-09-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerService/managedClusters/meshUpgradeProfiles@2023-09-02-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2023-09-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerService/managedClusters/privateEndpointConnections@2023-09-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2023-09-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerService/managedClusters/trustedAccessRoleBindings@2023-09-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2023-09-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerService/managedclustersnapshots@2023-09-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2023-09-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerService/snapshots@2023-09-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2023-09-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Function abort (Microsoft.ContainerService/managedclusters@2023-09-02-preview)
* **Resource**: Microsoft.ContainerService/managedclusters
* **ApiVersion**: 2023-09-02-preview

## Function abort (Microsoft.ContainerService/managedclusters/agentPools@2023-09-02-preview)
* **Resource**: Microsoft.ContainerService/managedclusters/agentPools
* **ApiVersion**: 2023-09-02-preview

## Function listClusterAdminCredential (Microsoft.ContainerService/managedClusters@2023-09-02-preview)
* **Resource**: Microsoft.ContainerService/managedClusters
* **ApiVersion**: 2023-09-02-preview
* **Output**: [CredentialResults](#credentialresults)

## Function listClusterMonitoringUserCredential (Microsoft.ContainerService/managedClusters@2023-09-02-preview)
* **Resource**: Microsoft.ContainerService/managedClusters
* **ApiVersion**: 2023-09-02-preview
* **Output**: [CredentialResults](#credentialresults)

## Function listClusterUserCredential (Microsoft.ContainerService/managedClusters@2023-09-02-preview)
* **Resource**: Microsoft.ContainerService/managedClusters
* **ApiVersion**: 2023-09-02-preview
* **Output**: [CredentialResults](#credentialresults)

## Function listCredential (Microsoft.ContainerService/managedClusters/accessProfiles@2023-09-02-preview)
...
## Function resetAADProfile (Microsoft.ContainerService/managedClusters@2023-09-02-preview)
* **Resource**: Microsoft.ContainerService/managedClusters
* **ApiVersion**: 2023-09-02-preview
* **Input**: [ManagedClusterAADProfile](#managedclusteraadprofile)

## Function resetServicePrincipalProfile (Microsoft.ContainerService/managedClusters@2023-09-02-preview)
* **Resource**: Microsoft.ContainerService/managedClusters
* **ApiVersion**: 2023-09-02-preview
* **Input**: [ManagedClusterServicePrincipalProfile](#managedclusterserviceprincipalprofile)

## Function resolvePrivateLinkServiceId (Microsoft.ContainerService/managedClusters@2023-09-02-preview)
* **Resource**: Microsoft.ContainerService/managedClusters
* **ApiVersion**: 2023-09-02-preview
* **Input**: [PrivateLinkResource](#privatelinkresource)
* **Output**: [PrivateLinkResource](#privatelinkresource)

## Function rotateClusterCertificates (Microsoft.ContainerService/managedClusters@2023-09-02-preview)
* **Resource**: Microsoft.ContainerService/managedClusters
* **ApiVersion**: 2023-09-02-preview

## Function rotateServiceAccountSigningKeys (Microsoft.ContainerService/managedClusters@2023-09-02-preview)
* **Resource**: Microsoft.ContainerService/managedClusters
* **ApiVersion**: 2023-09-02-preview

## Function runCommand (Microsoft.ContainerService/managedClusters@2023-09-02-preview)
* **Resource**: Microsoft.ContainerService/managedClusters
* **ApiVersion**: 2023-09-02-preview
* **Input**: [RunCommandRequest](#runcommandrequest)
* **Output**: [RunCommandResult](#runcommandresult)

## Function start (Microsoft.ContainerService/managedClusters@2023-09-02-preview)
* **Resource**: Microsoft.ContainerService/managedClusters
* **ApiVersion**: 2023-09-02-preview

## Function stop (Microsoft.ContainerService/managedClusters@2023-09-02-preview)
* **Resource**: Microsoft.ContainerService/managedClusters
* **ApiVersion**: 2023-09-02-preview

## Function upgradeNodeImageVersion (Microsoft.ContainerService/managedClusters/agentPools@2023-09-02-preview)
* **Resource**: Microsoft.ContainerService/managedClusters/agentPools
* **ApiVersion**: 2023-09-02-preview
...
### Properties
* **drainTimeoutInMinutes**: int: The amount of time (in minutes) to wait on eviction of pods and graceful termination per node. This eviction wait time honors waiting on pod disruption budgets. If this time is exceeded, the upgrade fails. If not specified, the default is 30 minutes.
...
* **nodeSoakDurationInMinutes**: int: The amount of time (in minutes) to wait after draining a node and before reimaging it and moving on to next node. If not specified, the default is 0 minutes.
...
### Properties
* **logs**: [ManagedClusterAzureMonitorProfileLogs](#managedclusterazuremonitorprofilelogs): Logs profile for the Azure Monitor Infrastructure and Application Logs. Collect out-of-the-box Kubernetes infrastructure & application logs to send to Azure Monitor. See aka.ms/AzureMonitorContainerInsights for an overview.
...
### Properties
* **enabled**: bool: Indicates if Application Monitoring enabled or not.
...
* **windowsHostLogs**: [ManagedClusterAzureMonitorProfileWindowsHostLogs](#managedclusterazuremonitorprofilewindowshostlogs): Windows Host Logs Profile for Kubernetes Windows Nodes Log Collection. Collects ETW, Event Logs and Text logs etc. See aka.ms/AzureMonitorContainerInsights for an overview.
...
### Properties
* **enabled**: bool: Indicates if Windows Host Log Collection is enabled or not for Azure Monitor Container Insights Logs Addon.

## ManagedClusterCostAnalysis
### Properties
* **enabled**: bool: The Managed Cluster sku.tier must be set to 'Standard' to enable this feature. Enabling this will add Kubernetes Namespace and Deployment details to the Cost Analysis views in the Azure portal. If not specified, the default is false. For more information see aka.ms/aks/docs/cost-analysis.
...
### Properties
* **dnsZoneResourceIds**: string[]: Resource IDs of the public DNS zones to be associated with the Web App Routing add-on. Used only when Web App Routing is enabled. All public DNS zones must be in the same resource group.
...
* **expanders**: 'least-waste' | 'most-pods' | 'priority' | 'random' | string[]: Available values are: 'least-waste', 'most-pods', 'priority', 'random'. If multiple expanders are configured, they will be considered in the order in which they are listed, with the first one being considered first.
