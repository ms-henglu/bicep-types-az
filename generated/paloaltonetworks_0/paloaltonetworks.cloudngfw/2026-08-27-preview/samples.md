...
```bicep
resource exampleResource 'PaloAltoNetworks.Cloudngfw/firewalls@2026-08-27-preview' = {
  name: 'example'
  identity: {
    type: 'None'
  ...
  properties: {
    ...
    networkProfile: {
      ...
      networkType: 'VNET'
      outboundIdleTimeoutInMinutes: 20
      outboundTcpReset: 'Enabled'
    ...
    sessionDrainTimeoutInMinutes: 30
  }
  tags: {
    tagName: 'value'
  }
...
## paloaltonetworks.cloudngfw/firewalls/customcaptureconfigurations

CustomCaptureConfigurationsFirewallResources_CreateOrUpdate_MaximumSet_Gen
```bicep
resource exampleResource 'PaloAltoNetworks.Cloudngfw/firewalls/customCaptureConfigurations@2026-08-27-preview' = {
...
## paloaltonetworks.cloudngfw/firewalls/logingestionsettings

LogIngestionSettingsResources_CreateOrUpdate_MaximumSet_Gen
```bicep
resource exampleResource 'PaloAltoNetworks.Cloudngfw/firewalls/logIngestionSettings@2026-08-27-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    commonDestination: {
...
LogIngestionSettingsResources_CreateOrUpdate_MinimumSet_Gen
```bicep
resource exampleResource 'PaloAltoNetworks.Cloudngfw/firewalls/logIngestionSettings@2026-08-27-preview' = {
  parent: parentResource 
  name: 'example'
...
## paloaltonetworks.cloudngfw/firewalls/metrics

MetricsObjectFirewall_CreateOrUpdate_MaximumSet_Gen
```bicep
resource exampleResource 'PaloAltoNetworks.Cloudngfw/firewalls/metrics@2026-08-27-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'PaloAltoNetworks.Cloudngfw/globalRulestacks@2026-08-27-preview' = {
  name: 'example'
  identity: {
    type: 'None'
    userAssignedIdentities: {
...
```bicep
resource exampleResource 'PaloAltoNetworks.Cloudngfw/globalRulestacks/certificates@2026-08-27-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'PaloAltoNetworks.Cloudngfw/globalRulestacks/fqdnlists@2026-08-27-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'PaloAltoNetworks.Cloudngfw/globalRulestacks/postRules@2026-08-27-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'PaloAltoNetworks.Cloudngfw/globalRulestacks/prefixlists@2026-08-27-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'PaloAltoNetworks.Cloudngfw/globalRulestacks/preRules@2026-08-27-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'PaloAltoNetworks.Cloudngfw/localRulestacks@2026-08-27-preview' = {
  name: 'example'
  identity: {
    type: 'None'
    userAssignedIdentities: {
...
```bicep
resource exampleResource 'PaloAltoNetworks.Cloudngfw/localRulestacks/certificates@2026-08-27-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'description'
...
```bicep
resource exampleResource 'PaloAltoNetworks.Cloudngfw/localRulestacks/fqdnlists@2026-08-27-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
...
```bicep
resource exampleResource 'PaloAltoNetworks.Cloudngfw/localRulestacks/localRules@2026-08-27-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'PaloAltoNetworks.Cloudngfw/localRulestacks/prefixlists@2026-08-27-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    description: 'string'
