# Microsoft.Elastic @ 2024-10-01-preview

## Resource Microsoft.Elastic/monitors@2024-10-01-preview
...
## Resource Microsoft.Elastic/monitors/monitoredSubscriptions@2024-10-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2024-10-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Elastic/monitors/openAIIntegrations@2024-10-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2024-10-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Elastic/monitors/tagRules@2024-10-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2024-10-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Function getStatus (Microsoft.Elastic/monitors/openAIIntegrations@2024-10-01-preview)
...
## Function listAllTrafficFilters (Microsoft.Elastic/monitors@2024-10-01-preview)
* **Resource**: Microsoft.Elastic/monitors
* **ApiVersion**: 2024-10-01-preview
* **Output**: [ElasticTrafficFilterResponse](#elastictrafficfilterresponse)

## Function listAssociatedTrafficFilters (Microsoft.Elastic/monitors@2024-10-01-preview)
* **Resource**: Microsoft.Elastic/monitors
* **ApiVersion**: 2024-10-01-preview
* **Output**: [ElasticTrafficFilterResponse](#elastictrafficfilterresponse)

## Function listConnectedPartnerResources (Microsoft.Elastic/monitors@2024-10-01-preview)
* **Resource**: Microsoft.Elastic/monitors
* **ApiVersion**: 2024-10-01-preview
* **Output**: [ConnectedPartnerResourcesListResponse](#connectedpartnerresourceslistresponse)

## Function listDeploymentInfo (Microsoft.Elastic/monitors@2024-10-01-preview)
* **Resource**: Microsoft.Elastic/monitors
* **ApiVersion**: 2024-10-01-preview
* **Output**: [DeploymentInfoResponse](#deploymentinforesponse)

## Function listMonitoredResources (Microsoft.Elastic/monitors@2024-10-01-preview)
* **Resource**: Microsoft.Elastic/monitors
* **ApiVersion**: 2024-10-01-preview
* **Output**: [MonitoredResourceListResponse](#monitoredresourcelistresponse)

## Function listUpgradableVersions (Microsoft.Elastic/monitors@2024-10-01-preview)
* **Resource**: Microsoft.Elastic/monitors
* **ApiVersion**: 2024-10-01-preview
* **Output**: [UpgradableVersionsList](#upgradableversionslist)

## Function listVMHost (Microsoft.Elastic/monitors@2024-10-01-preview)
* **Resource**: Microsoft.Elastic/monitors
* **ApiVersion**: 2024-10-01-preview
* **Output**: [VMHostListResponse](#vmhostlistresponse)

## Function resubscribe (Microsoft.Elastic/monitors@2024-10-01-preview)
* **Resource**: Microsoft.Elastic/monitors
* **ApiVersion**: 2024-10-01-preview
