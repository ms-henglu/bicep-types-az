...
## Resource Microsoft.Cdn/profiles/endpoints/origins@2019-06-15-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2019-06-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Function checkResourceUsage (Microsoft.Cdn/profiles@2019-06-15-preview)
* **Resource**: Microsoft.Cdn/profiles
* **ApiVersion**: 2019-06-15-preview
* **Output**: [ResourceUsageListResult](#resourceusagelistresult)

## Function checkResourceUsage (Microsoft.Cdn/profiles/endpoints@2019-06-15-preview)
* **Resource**: Microsoft.Cdn/profiles/endpoints
* **ApiVersion**: 2019-06-15-preview
* **Output**: [ResourceUsageListResult](#resourceusagelistresult)

## Function disableCustomHttps (Microsoft.Cdn/profiles/endpoints/customDomains@2019-06-15-preview)
* **Resource**: Microsoft.Cdn/profiles/endpoints/customDomains
* **ApiVersion**: 2019-06-15-preview

## Function enableCustomHttps (Microsoft.Cdn/profiles/endpoints/customDomains@2019-06-15-preview)
* **Resource**: Microsoft.Cdn/profiles/endpoints/customDomains
* **ApiVersion**: 2019-06-15-preview
* **Input**: [CustomDomainHttpsParameters](#customdomainhttpsparameters)

## Function generateSsoUri (Microsoft.Cdn/profiles@2019-06-15-preview)
* **Resource**: Microsoft.Cdn/profiles
* **ApiVersion**: 2019-06-15-preview
* **Output**: [SsoUri](#ssouri)

## Function getSupportedOptimizationTypes (Microsoft.Cdn/profiles@2019-06-15-preview)
* **Resource**: Microsoft.Cdn/profiles
* **ApiVersion**: 2019-06-15-preview
* **Output**: [SupportedOptimizationTypesListResult](#supportedoptimizationtypeslistresult)

## Function load (Microsoft.Cdn/profiles/endpoints@2019-06-15-preview)
* **Resource**: Microsoft.Cdn/profiles/endpoints
* **ApiVersion**: 2019-06-15-preview
* **Input**: [LoadParameters](#loadparameters)

## Function purge (Microsoft.Cdn/profiles/endpoints@2019-06-15-preview)
* **Resource**: Microsoft.Cdn/profiles/endpoints
* **ApiVersion**: 2019-06-15-preview
* **Input**: [PurgeParameters](#purgeparameters)

## Function start (Microsoft.Cdn/profiles/endpoints@2019-06-15-preview)
* **Resource**: Microsoft.Cdn/profiles/endpoints
* **ApiVersion**: 2019-06-15-preview
* **Output**: [Endpoint](#endpoint)

## Function stop (Microsoft.Cdn/profiles/endpoints@2019-06-15-preview)
* **Resource**: Microsoft.Cdn/profiles/endpoints
* **ApiVersion**: 2019-06-15-preview
* **Output**: [Endpoint](#endpoint)

## Function validateCustomDomain (Microsoft.Cdn/profiles/endpoints@2019-06-15-preview)
* **Resource**: Microsoft.Cdn/profiles/endpoints
* **ApiVersion**: 2019-06-15-preview
...
* **transforms**: 'Lowercase' | 'Uppercase' | string[]: List of transforms
...
* **matchValues**: 'Desktop' | 'Mobile' | string[] (Required): The match value for the condition of the delivery rule
* **negateCondition**: bool: Describes if this is negate condition or not
* **operator**: 'Equal' | string (Required): Describes operator to be matched
* **transforms**: 'Lowercase' | 'Uppercase' | string[]: List of transforms
...
* **matchValues**: 'DELETE' | 'GET' | 'HEAD' | 'OPTIONS' | 'POST' | 'PUT' | 'TRACE' | string[] (Required): The match value for the condition of the delivery rule
* **negateCondition**: bool: Describes if this is negate condition or not
* **operator**: 'Equal' | string (Required): Describes operator to be matched
...
* **matchValues**: 'HTTP' | 'HTTPS' | string[] (Required): The match value for the condition of the delivery rule
* **negateCondition**: bool: Describes if this is negate condition or not
* **operator**: 'Equal' | string (Required): Describes operator to be matched
