...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/backupconfig@2026-08-01' = {
...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/backupEncryptionConfigs@2026-08-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/backupFabrics/backupProtectionIntent@2026-08-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
Re-register Azure Storage ProtectionContainers switching to System Assigned Managed Identity
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/backupFabrics/protectionContainers@2026-08-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
Re-register Azure Storage ProtectionContainers switching to User Assigned Managed Identity
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/backupFabrics/protectionContainers@2026-08-01' = {
  parent: parentResource 
  name: 'example'
...
Register Azure Storage ProtectionContainers with System Assigned Managed Identity
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/backupFabrics/protectionContainers@2026-08-01' = {
  parent: parentResource 
  name: 'example'
...
Register Azure Storage ProtectionContainers with User Assigned Managed Identity
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/backupFabrics/protectionContainers@2026-08-01' = {
  parent: parentResource 
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/backupFabrics/protectionContainers/protectedItems@2026-08-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/backupPolicies@2026-08-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    backupManagementType: 'AzureStorage'
...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/backupResourceGuardProxies@2026-08-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/backupstorageconfig@2026-08-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.RecoveryServices/vaults/privateEndpointConnections@2026-08-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    groupIds: [
