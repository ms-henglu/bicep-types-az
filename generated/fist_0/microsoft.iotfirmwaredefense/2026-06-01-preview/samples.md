...
```bicep
resource exampleResource 'Microsoft.IoTFirmwareDefense/workspaces@2026-06-01-preview' = {
  name: 'example'
  location: 'East US'
  properties: {
  }
...
```bicep
resource exampleResource 'Microsoft.IoTFirmwareDefense/workspaces/firmwares@2026-06-01-preview' = {
