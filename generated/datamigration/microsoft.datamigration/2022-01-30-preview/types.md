# Microsoft.DataMigration @ 2022-01-30-preview
...
## Resource Microsoft.DataMigration/services/projects/files@2022-01-30-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2022-01-30-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string: HTTP strong entity tag value. This is ignored if submitted.
...
## Function cancel (Microsoft.DataMigration/databaseMigrations@2022-01-30-preview)
...
## Function cancel (Microsoft.DataMigration/services/projects/tasks@2022-01-30-preview)
* **Resource**: Microsoft.DataMigration/services/projects/tasks
* **ApiVersion**: 2022-01-30-preview
* **Output**: [ProjectTask](#projecttask)

## Function cancel (Microsoft.DataMigration/services/serviceTasks@2022-01-30-preview)
* **Resource**: Microsoft.DataMigration/services/serviceTasks
* **ApiVersion**: 2022-01-30-preview
* **Output**: [ProjectTask](#projecttask)

## Function checkNameAvailability (Microsoft.DataMigration/services@2022-01-30-preview)
...
## Function checkNameAvailability (Microsoft.DataMigration/locations@2022-01-30-preview)
* **Resource**: Microsoft.DataMigration/locations
* **ApiVersion**: 2022-01-30-preview
* **Input**: [NameAvailabilityRequest](#nameavailabilityrequest)
* **Output**: [NameAvailabilityResponse](#nameavailabilityresponse)

## Function checkStatus (Microsoft.DataMigration/services@2022-01-30-preview)
* **Resource**: Microsoft.DataMigration/services
* **ApiVersion**: 2022-01-30-preview
* **Output**: [DataMigrationServiceStatusResponse](#datamigrationservicestatusresponse)

## Function command (Microsoft.DataMigration/services/projects/tasks@2022-01-30-preview)
* **Resource**: Microsoft.DataMigration/services/projects/tasks
* **ApiVersion**: 2022-01-30-preview
* **Input**: [CommandProperties](#commandproperties)
* **Output**: [CommandProperties](#commandproperties)

## Function cutover (Microsoft.DataMigration/databaseMigrations@2022-01-30-preview)
* **Resource**: Microsoft.DataMigration/databaseMigrations
* **ApiVersion**: 2022-01-30-preview
* **Input**: [MigrationOperationInput](#migrationoperationinput)

## Function deleteNode (Microsoft.DataMigration/sqlMigrationServices@2022-01-30-preview)
...
## Function read (Microsoft.DataMigration/services/projects/files@2022-01-30-preview)
* **Resource**: Microsoft.DataMigration/services/projects/files
* **ApiVersion**: 2022-01-30-preview
* **Output**: [FileStorageInfo](#filestorageinfo)

## Function readwrite (Microsoft.DataMigration/services/projects/files@2022-01-30-preview)
* **Resource**: Microsoft.DataMigration/services/projects/files
* **ApiVersion**: 2022-01-30-preview
* **Output**: [FileStorageInfo](#filestorageinfo)

## Function regenerateAuthKeys (Microsoft.DataMigration/sqlMigrationServices@2022-01-30-preview)
* **Resource**: Microsoft.DataMigration/sqlMigrationServices
* **ApiVersion**: 2022-01-30-preview
* **Input**: [RegenAuthKeys](#regenauthkeys)
* **Output**: [RegenAuthKeys](#regenauthkeys)

## Function start (Microsoft.DataMigration/services@2022-01-30-preview)
* **Resource**: Microsoft.DataMigration/services
* **ApiVersion**: 2022-01-30-preview

## Function stop (Microsoft.DataMigration/services@2022-01-30-preview)
* **Resource**: Microsoft.DataMigration/services
* **ApiVersion**: 2022-01-30-preview
...
## SourceLocation
### Properties
* **azureBlob**: [AzureBlob](#azureblob): Source Azure Blob.
* **fileShare**: [SqlFileShare](#sqlfileshare): Source File share.
...
* **familySequenceNumber**: int (ReadOnly): Media family sequence number
* **fileName**: string (ReadOnly): File name.
* **status**: string (ReadOnly): Status of the file. (Initial, Uploading, Uploaded, Restoring, Restored or Skipped)
* **totalSize**: int (ReadOnly): File size in bytes
...
* **firstLSN**: string (ReadOnly): First LSN of the backup set.
* **hasBackupChecksums**: bool (ReadOnly): Has Backup Checksums
* **ignoreReasons**: string[] (ReadOnly): The reasons why the backup set is ignored
* **isBackupRestored**: bool (ReadOnly): Whether this backup set has been restored or not.
* **lastLSN**: string (ReadOnly): Last LSN of the backup set.
* **listOfBackupFiles**: [SqlBackupFileInfo](#sqlbackupfileinfo)[] (ReadOnly): List of files in the backup set.
...
* **createdAt**: string
* **createdBy**: string
* **createdByType**: 'Application' | 'Key' | 'ManagedIdentity' | 'User' | string
...
* **storageAccountResourceId**: string: Resource Id of the storage account copying backups.
