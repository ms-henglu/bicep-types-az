...
## Function cancel (Microsoft.DataMigration/services/projects/tasks@2017-11-15-preview)
* **Resource**: Microsoft.DataMigration/services/projects/tasks
* **ApiVersion**: 2017-11-15-preview
* **Output**: [ProjectTask](#projecttask)

## Function checkNameAvailability (Microsoft.DataMigration/services@2017-11-15-preview)
...
## Function checkNameAvailability (Microsoft.DataMigration/locations@2017-11-15-preview)
* **Resource**: Microsoft.DataMigration/locations
* **ApiVersion**: 2017-11-15-preview
* **Input**: [NameAvailabilityRequest](#nameavailabilityrequest)
* **Output**: [NameAvailabilityResponse](#nameavailabilityresponse)

## Function checkStatus (Microsoft.DataMigration/services@2017-11-15-preview)
* **Resource**: Microsoft.DataMigration/services
* **ApiVersion**: 2017-11-15-preview
...
* **stage**: 'Backup' | 'Completed' | 'FileCopy' | 'Initialize' | 'None' | 'Restore' (ReadOnly): Migration stage that this database is in
...
* **reason**: 'AlreadyExists' | 'Invalid': The reason why the name is not available, if nameAvailable is false
