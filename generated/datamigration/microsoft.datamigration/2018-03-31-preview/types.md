...
## Function cancel (Microsoft.DataMigration/services/projects/tasks@2018-03-31-preview)
* **Resource**: Microsoft.DataMigration/services/projects/tasks
* **ApiVersion**: 2018-03-31-preview
* **Output**: [ProjectTask](#projecttask)

## Function checkNameAvailability (Microsoft.DataMigration/services@2018-03-31-preview)
...
## Function checkNameAvailability (Microsoft.DataMigration/locations@2018-03-31-preview)
* **Resource**: Microsoft.DataMigration/locations
* **ApiVersion**: 2018-03-31-preview
* **Input**: [NameAvailabilityRequest](#nameavailabilityrequest)
* **Output**: [NameAvailabilityResponse](#nameavailabilityresponse)

## Function checkStatus (Microsoft.DataMigration/services@2018-03-31-preview)
* **Resource**: Microsoft.DataMigration/services
* **ApiVersion**: 2018-03-31-preview
...
* **stage**: 'AssignRoleMembership' | 'AssignRoleOwnership' | 'Completed' | 'EstablishObjectPermissions' | 'EstablishServerPermissions' | 'EstablishUserMapping' | 'Initialize' | 'LoginMigration' | 'None' (ReadOnly): Current stage of login
...
* **targetPlatform**: 'SQLDB' | 'SQLMI' | 'Unknown' | string (Required): Target platform for the project
