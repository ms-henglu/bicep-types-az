...
```bicep
resource exampleResource 'Microsoft.Cdn/cdnWebApplicationFirewallPolicies@2026-08-01-preview' = {
  name: 'example'
  location: 'WestUs'
  properties: {
    customRules: {
...
Profiles_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles@2026-08-01-preview' = {
  name: 'example'
  location: 'global'
  sku: {
...
AFDEndpoints_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/afdEndpoints@2026-08-01-preview' = {
...
Routes_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/afdEndpoints/routes@2026-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    cacheConfiguration: {
...
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/customDomains@2026-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    azureDnsZone: {
...
Endpoints_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/endpoints@2026-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'WestUs'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/endpoints/customDomains@2026-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    hostName: 'www.someDomain.net'
...
OriginGroups_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/endpoints/originGroups@2026-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    healthProbeSettings: {
...
Origins_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/endpoints/origins@2026-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    enabled: true
...
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/originGroups@2026-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    authentication: {
    ...
    loadBalancingSettings: {
      ...
      capacityDistributionSettings: {
        capacityConsciousThreshold: 80
        distributionType: 'StaticWeights'
      }
      sampleSize: 3
...
AFDOrigins_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/originGroups/origins@2026-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    enabledState: 'Enabled'
...
AFDOrigins_Create_CustomCertificateSubject
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/originGroups/origins@2026-08-01-preview' = {
  parent: parentResource 
  name: 'example'
...
AFDOrigins_Create_IncomingHostHeaderValidation
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/originGroups/origins@2026-08-01-preview' = {
  parent: parentResource 
  name: 'example'
...
AFDOrigins_Create_OriginHostname
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/originGroups/origins@2026-08-01-preview' = {
  parent: parentResource 
  name: 'example'
...
Rules_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/ruleSets/rules@2026-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    actions: [
...
Secrets_Create
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/secrets@2026-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    parameters: {
...
```bicep
resource exampleResource 'Microsoft.Cdn/profiles/securityPolicies@2026-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    parameters: {
