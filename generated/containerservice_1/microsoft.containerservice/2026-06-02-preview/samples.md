...
```bicep
resource exampleResource 'Microsoft.ContainerService/maintenanceWindows@2026-06-02-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
    durationHours: 8
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters@2026-06-02-preview' = {
  name: 'example'
  location: 'location1'
  properties: {
    addonProfiles: {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/agentPools@2026-06-02-preview' = {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/agentPools/machines@2026-06-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    hardware: {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/alertConfigurations@2026-06-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    mode: 'Managed'
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/identityBindings@2026-06-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    managedIdentity: {
...
Create or update Identity Binding with allowed subjects
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/identityBindings@2026-06-02-preview' = {
  parent: parentResource 
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/jwtAuthenticators@2026-06-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    claimMappings: {
...
Create or update JWT Authenticator With Custom CA Bundle
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/jwtAuthenticators@2026-06-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    certificateAuthorityBundle: '-----BEGIN CERTIFICATE-----\nMII...rest of the certificate1...\n-----END CERTIFICATE-----'
    claimMappings: {
      extra: [
        {
          key: 'example.com/extrakey'
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/loadBalancers@2026-06-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
Create a Linked Maintenance Configuration
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/maintenanceConfigurations@2026-06-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    maintenanceWindowId: '/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.ContainerService/maintenanceWindows/myMaintenanceWindow'
  }
}
```
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/managedNamespaces@2026-06-02-preview' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus2'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/meshMemberships@2026-06-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/privateEndpointConnections@2026-06-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedClusters/trustedAccessRoleBindings@2026-06-02-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    roles: [
...
```bicep
resource exampleResource 'Microsoft.ContainerService/managedclustersnapshots@2026-06-02-preview' = {
  name: 'example'
  location: 'westus'
  properties: {
    creationData: {
...
```bicep
resource exampleResource 'Microsoft.ContainerService/snapshots@2026-06-02-preview' = {
  name: 'example'
  location: 'westus'
  properties: {
    creationData: {
