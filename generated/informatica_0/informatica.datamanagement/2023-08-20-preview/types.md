...
## Function checkDependencies (Informatica.DataManagement/organizations/serverlessRuntimes@2023-08-20-preview)
* **Resource**: Informatica.DataManagement/organizations/serverlessRuntimes
* **ApiVersion**: 2023-08-20-preview
* **Output**: [CheckDependenciesResponse](#checkdependenciesresponse)

## Function getAllServerlessRuntimes (Informatica.DataManagement/organizations@2023-08-20-preview)
...
## Function getServerlessMetadata (Informatica.DataManagement/organizations@2023-08-20-preview)
* **Resource**: Informatica.DataManagement/organizations
* **ApiVersion**: 2023-08-20-preview
* **Output**: [ServerlessMetadataResponse](#serverlessmetadataresponse)

## Function serverlessResourceById (Informatica.DataManagement/organizations/serverlessRuntimes@2023-08-20-preview)
* **Resource**: Informatica.DataManagement/organizations/serverlessRuntimes
* **ApiVersion**: 2023-08-20-preview
* **Output**: [InformaticaServerlessRuntimeResource](#informaticaserverlessruntimeresource)

## Function startFailedServerlessRuntime (Informatica.DataManagement/organizations/serverlessRuntimes@2023-08-20-preview)
* **Resource**: Informatica.DataManagement/organizations/serverlessRuntimes
* **ApiVersion**: 2023-08-20-preview
