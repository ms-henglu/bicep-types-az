...
## Function checkDependencies (Informatica.DataManagement/organizations/serverlessRuntimes@2023-03-01-preview)
...
## Function getAllServerlessRuntimes (Informatica.DataManagement/organizations@2023-03-01-preview)
...
## Function getServerlessMetadata (Informatica.DataManagement/organizations@2023-03-01-preview)
* **Resource**: Informatica.DataManagement/organizations
* **ApiVersion**: 2023-03-01-preview
* **Output**: [ServerlessMetadataResponse](#serverlessmetadataresponse)

## Function serverlessResourceById (Informatica.DataManagement/organizations/serverlessRuntimes@2023-03-01-preview)
* **Resource**: Informatica.DataManagement/organizations/serverlessRuntimes
* **ApiVersion**: 2023-03-01-preview
* **Output**: [InformaticaServerlessRuntimeResource](#informaticaserverlessruntimeresource)

## Function startFailedServerlessRuntime (Informatica.DataManagement/organizations/serverlessRuntimes@2023-03-01-preview)
* **Resource**: Informatica.DataManagement/organizations/serverlessRuntimes
* **ApiVersion**: 2023-03-01-preview
