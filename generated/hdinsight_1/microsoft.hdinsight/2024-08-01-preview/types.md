...
## Resource Microsoft.HDInsight/clusters@2024-08-01-preview
...
## Resource Microsoft.HDInsight/clusters/applications@2024-08-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2024-08-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.HDInsight/clusters/privateEndpointConnections@2024-08-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2024-08-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.HDInsight/clusters/privateLinkResources@2024-08-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2024-08-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Function autoscale (Microsoft.HDInsight/clusters/roles@2024-08-01-preview)
...
## Function checkNameAvailability (Microsoft.HDInsight/locations@2024-08-01-preview)
...
## Function configurations (Microsoft.HDInsight/clusters@2024-08-01-preview)
* **Resource**: Microsoft.HDInsight/clusters
* **ApiVersion**: 2024-08-01-preview
* **Output**: [ClusterConfigurations](#clusterconfigurations)

## Function executeScriptActions (Microsoft.HDInsight/clusters@2024-08-01-preview)
* **Resource**: Microsoft.HDInsight/clusters
* **ApiVersion**: 2024-08-01-preview
* **Input**: [ExecuteScriptActionParameters](#executescriptactionparameters)

## Function getGatewaySettings (Microsoft.HDInsight/clusters@2024-08-01-preview)
* **Resource**: Microsoft.HDInsight/clusters
* **ApiVersion**: 2024-08-01-preview
* **Output**: [GatewaySettings](#gatewaysettings)

## Function listHosts (Microsoft.HDInsight/clusters@2024-08-01-preview)
* **Resource**: Microsoft.HDInsight/clusters
* **ApiVersion**: 2024-08-01-preview
* **Output**: [HostInfo](#hostinfo)[]

## Function promote (Microsoft.HDInsight/clusters/scriptExecutionHistory@2024-08-01-preview)
* **Resource**: Microsoft.HDInsight/clusters/scriptExecutionHistory
* **ApiVersion**: 2024-08-01-preview

## Function resize (Microsoft.HDInsight/clusters/roles@2024-08-01-preview)
* **Resource**: Microsoft.HDInsight/clusters/roles
* **ApiVersion**: 2024-08-01-preview
* **Input**: [ClusterResizeParameters](#clusterresizeparameters)

## Function restartHosts (Microsoft.HDInsight/clusters@2024-08-01-preview)
* **Resource**: Microsoft.HDInsight/clusters
* **ApiVersion**: 2024-08-01-preview
* **Input**: string[]

## Function rotatediskencryptionkey (Microsoft.HDInsight/clusters@2024-08-01-preview)
* **Resource**: Microsoft.HDInsight/clusters
* **ApiVersion**: 2024-08-01-preview
* **Input**: [ClusterDiskEncryptionParameters](#clusterdiskencryptionparameters)

## Function updateClusterIdentityCertificate (Microsoft.HDInsight/clusters@2024-08-01-preview)
* **Resource**: Microsoft.HDInsight/clusters
* **ApiVersion**: 2024-08-01-preview
* **Input**: [UpdateClusterIdentityCertificateParameters](#updateclusteridentitycertificateparameters)

## Function updateGatewaySettings (Microsoft.HDInsight/clusters@2024-08-01-preview)
* **Resource**: Microsoft.HDInsight/clusters
* **ApiVersion**: 2024-08-01-preview
* **Input**: [UpdateGatewaySettingsParameters](#updategatewaysettingsparameters)

## Function validateCreateRequest (Microsoft.HDInsight/locations@2024-08-01-preview)
* **Resource**: Microsoft.HDInsight/locations
* **ApiVersion**: 2024-08-01-preview
