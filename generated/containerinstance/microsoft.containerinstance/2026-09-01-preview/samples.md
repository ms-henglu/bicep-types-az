...
## microsoft.containerinstance/aiagentsgroups

Create or update a AiAgentsGroup
```bicep
resource exampleResource 'Microsoft.ContainerInstance/aiAgentsGroups@2026-09-01-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
    networkProfile: {
...
```bicep
resource exampleResource 'Microsoft.ContainerInstance/containerGroups@2026-09-01-preview' = {
  name: 'example'
  location: 'westeurope'
  properties: {
...
ContainerGroupsCreateOrUpdateManagedIdentityAzureFileshare
```bicep
resource exampleResource 'Microsoft.ContainerInstance/containerGroups@2026-09-01-preview' = {
  name: 'example'
  identity: {
...
## microsoft.containerinstance/managedvirtualnodepools

Create or update a managed virtual node pool
```bicep
resource exampleResource 'Microsoft.ContainerInstance/managedVirtualNodePools@2026-09-01-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
    aiAgentGroupResourceId: '/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/demo/providers/Microsoft.ContainerInstance/aiAgentsGroups/demo-aag'
    aksClusterResourceId: '/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/demo/providers/Microsoft.ContainerService/managedClusters/demo-aks'
    managedIdentityResourceId: '/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/demo/providers/Microsoft.ManagedIdentity/userAssignedIdentities/demo-mi'
    maxNodes: 5
    minNodes: 1
  }
  tags: {
