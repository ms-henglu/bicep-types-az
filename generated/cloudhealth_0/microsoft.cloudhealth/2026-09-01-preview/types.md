...
## Function addDataAnnotation (Microsoft.CloudHealth/healthmodels/entities@2026-09-01-preview)
...
## Function getDataAnnotations (Microsoft.CloudHealth/healthmodels/entities@2026-09-01-preview)
* **Resource**: Microsoft.CloudHealth/healthmodels/entities
* **ApiVersion**: 2026-09-01-preview
* **Input**: [GetDataAnnotationsRequest](#getdataannotationsrequest)
* **Output**: [GetDataAnnotationsResponse](#getdataannotationsresponse)

## Function getHistory (Microsoft.CloudHealth/healthmodels/entities@2026-09-01-preview)
* **Resource**: Microsoft.CloudHealth/healthmodels/entities
* **ApiVersion**: 2026-09-01-preview
* **Input**: [EntityHistoryRequest](#entityhistoryrequest)
* **Output**: [EntityHistoryResponse](#entityhistoryresponse)

## Function getSignalHistory (Microsoft.CloudHealth/healthmodels/entities@2026-09-01-preview)
* **Resource**: Microsoft.CloudHealth/healthmodels/entities
* **ApiVersion**: 2026-09-01-preview
* **Input**: [SignalHistoryRequest](#signalhistoryrequest)
* **Output**: [SignalHistoryResponse](#signalhistoryresponse)

## Function getSignalRecommendations (Microsoft.CloudHealth/healthmodels/entities@2026-09-01-preview)
* **Resource**: Microsoft.CloudHealth/healthmodels/entities
* **ApiVersion**: 2026-09-01-preview
* **Output**: [GetSignalRecommendationsResponse](#getsignalrecommendationsresponse)

## Function ingestHealthReport (Microsoft.CloudHealth/healthmodels/entities@2026-09-01-preview)
* **Resource**: Microsoft.CloudHealth/healthmodels/entities
* **ApiVersion**: 2026-09-01-preview
...
* **healthState**: 'Degraded' | 'Healthy' | 'Unhealthy' | 'Unknown' | string (Required): Health state to report for the signal
...
### Properties
* **newState**: 'Degraded' | 'Healthy' | 'Unhealthy' | 'Unknown' | string (Required): New health state after the transition
* **occurredAt**: string (Required): Timestamp when the transition occurred
* **previousState**: 'Degraded' | 'Healthy' | 'Unhealthy' | 'Unknown' | string (Required): Previous health state before the transition
...
### Properties
* **additionalContext**: string {maxLength: 4096}: Additional context as provided by the submitter
* **healthState**: 'Degraded' | 'Healthy' | 'Unhealthy' | 'Unknown' | string (Required): Health state at this point in time
