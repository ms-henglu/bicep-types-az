# Microsoft.Media @ 2022-05-01-preview

## Resource Microsoft.Media/mediaServices/transforms@2022-05-01-preview
...
## Resource Microsoft.Media/mediaServices/transforms/jobs@2022-05-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2022-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Function cancelJob (Microsoft.Media/mediaServices/transforms/jobs@2022-05-01-preview)
...
### CmafFormat
#### Properties
* **@odata.type**: '#Microsoft.Media.CmafFormat' (Required): The discriminator for derived types.
...
* **streamingFormat**: 'Dash' | 'Hls' | 'HlsAndDash' | string
...
* **outputFormat**: [Format](#format): Sets the output format type. Only Mp4Format and CmafFormat are supported in current implementation. Example: set OutputFormat as CmafFormat to produce audio/video stream variant and manifest files for streaming.
