...
```bicep
resource exampleResource 'Microsoft.Mission/approvals@2026-04-01' = {
  name: 'example'
  properties: {
    approvers: [
      {
...
```bicep
resource exampleResource 'Microsoft.Mission/communities@2026-04-01' = {
  name: 'example'
  identity: {
...
```bicep
resource exampleResource 'Microsoft.Mission/communities/communityEndpoints@2026-04-01' = {
...
```bicep
resource exampleResource 'Microsoft.Mission/communities/dedicatedHubs@2026-04-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Mission/communities/transitHubs@2026-04-01' = {
  parent: parentResource 
  name: 'example'
  location: 'westcentralus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Mission/enclaveConnections@2026-04-01' = {
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Mission/virtualEnclaves@2026-04-01' = {
  name: 'example'
  identity: {
    type: 'SystemAssigned,UserAssigned'
    userAssignedIdentities: {
...
```bicep
resource exampleResource 'Microsoft.Mission/virtualEnclaves/enclaveEndpoints@2026-04-01' = {
  parent: parentResource 
  name: 'example'
  location: 'West US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Mission/virtualEnclaves/workloads@2026-04-01' = {
  parent: parentResource 
  name: 'example'
  location: 'westcentralus'
  properties: {
