...
```bicep
resource exampleResource 'Microsoft.Compute/locations/bulkCreateCustom@2026-08-06-preview' = {
...
```bicep
resource exampleResource 'Microsoft.Compute/locations/launchBulkInstancesOperations@2026-08-06-preview' = {
  parent: parentResource 
  name: 'example'
  identity: {
    type: 'None'
...
```bicep
resource exampleResource 'Microsoft.Compute/scheduledActions@2026-08-06-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
    actionType: 'Start'
