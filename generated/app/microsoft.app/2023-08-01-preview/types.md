...
* **token**: string (ReadOnly): Authentication token.
...
### Properties
* **key**: string: The data dog api key
...
* **githubPersonalAccessToken**: string (WriteOnly): One time Github PAT to configure github environment
