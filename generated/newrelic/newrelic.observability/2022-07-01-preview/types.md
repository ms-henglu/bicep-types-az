...
## Function getMetricRules (NewRelic.Observability/monitors@2022-07-01-preview)
* **Resource**: NewRelic.Observability/monitors
* **ApiVersion**: 2022-07-01-preview
* **Input**: [MetricsRequest](#metricsrequest)
* **Output**: [MetricRules](#metricrules)

## Function getMetricStatus (NewRelic.Observability/monitors@2022-07-01-preview)
* **Resource**: NewRelic.Observability/monitors
* **ApiVersion**: 2022-07-01-preview
...
## Function monitoredResources (NewRelic.Observability/monitors@2022-07-01-preview)
* **Resource**: NewRelic.Observability/monitors
* **ApiVersion**: 2022-07-01-preview
* **Output**: [MonitoredResourceListResponse](#monitoredresourcelistresponse)

## Function switchBilling (NewRelic.Observability/monitors@2022-07-01-preview)
* **Resource**: NewRelic.Observability/monitors
* **ApiVersion**: 2022-07-01-preview
* **Input**: [SwitchBillingRequest](#switchbillingrequest)
* **Output**: [NewRelicMonitorResource](#newrelicmonitorresource)

## Function vmHostPayloads (NewRelic.Observability/monitors@2022-07-01-preview)
* **Resource**: NewRelic.Observability/monitors
* **ApiVersion**: 2022-07-01-preview
