...
## AccountSasToken
### Properties
* **storageAccountSasToken**: string (Required): Field to specify storage account sas token.
...
## ContainerSasToken
### Properties
* **storageContainerSasToken**: string (Required): Field to specify storage container sas token.
