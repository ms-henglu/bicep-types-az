...
## Resource Microsoft.MachineLearningServices/workspaces/featuresets/versions/features@2023-10-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2023-10-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
#### Properties
* **componentId**: string (Required): [Required] Reference to the component asset used to calculate the custom metrics.
