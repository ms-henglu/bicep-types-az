...
## Function prepareNotebook (Microsoft.MachineLearningServices/workspaces@2020-06-01)
* **Resource**: Microsoft.MachineLearningServices/workspaces
* **ApiVersion**: 2020-06-01
* **Output**: [NotebookResourceInfo](#notebookresourceinfo)

## Function restart (Microsoft.MachineLearningServices/workspaces/computes@2020-06-01)
* **Resource**: Microsoft.MachineLearningServices/workspaces/computes
* **ApiVersion**: 2020-06-01

## Function resyncKeys (Microsoft.MachineLearningServices/workspaces@2020-06-01)
* **Resource**: Microsoft.MachineLearningServices/workspaces
* **ApiVersion**: 2020-06-01

## Function start (Microsoft.MachineLearningServices/workspaces/computes@2020-06-01)
* **Resource**: Microsoft.MachineLearningServices/workspaces/computes
* **ApiVersion**: 2020-06-01

## Function stop (Microsoft.MachineLearningServices/workspaces/computes@2020-06-01)
* **Resource**: Microsoft.MachineLearningServices/workspaces/computes
* **ApiVersion**: 2020-06-01

## Function updateQuotas (Microsoft.MachineLearningServices/locations@2020-06-01)
...
* **state**: 'CreateFailed' | 'Creating' | 'Deleting' | 'JobRunning' | 'RestartFailed' | 'Restarting' | 'Running' | 'SettingUp' | 'StartFailed' | 'Starting' | 'StopFailed' | 'Stopped' | 'Stopping' | 'Unknown' | 'Unusable' | 'UserSettingUp' | string (ReadOnly): The current state of this ComputeInstance.
* **subnet**: [ResourceId](#resourceid): Virtual network subnet resource ID the compute nodes belong to.
* **vmSize**: string: Virtual Machine Size
