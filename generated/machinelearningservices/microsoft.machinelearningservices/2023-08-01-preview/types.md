...
## Resource Microsoft.MachineLearningServices/workspaces/featuresets/versions/features@2023-08-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2023-08-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
* **groupId**: string (Required): [Required] Group within the same pool with which this endpoint needs to be associated with.
...
* **nodeSkuType**: string (Required): [Required] Compute instance type.
* **properties**: [PropertiesBaseProperties](#propertiesbaseproperties): Property dictionary. Properties can be added, but not removed or altered.
...
### Properties
* **capacityReservationGroupId**: string (Required): [Required] Specifies a capacity reservation group ID to allocate capacity from.
...
## ServerlessOffer
### Properties
* **offerName**: string (Required): [Required] The name of the Serverless Offer
* **publisher**: string (Required): [Required] Publisher name of the Serverless Offer
