...
```bicep
resource exampleResource 'Microsoft.Storage/contextCaches@2026-06-01' = {
  name: 'example'
  identity: {
    type: 'SystemAssigned'
  }
...
```bicep
resource exampleResource 'Microsoft.Storage/contextCaches/contextCacheContainers@2026-06-01' = {
...
NfsV3AccountCreate
```bicep
resource exampleResource 'Microsoft.Storage/storageAccounts@2026-06-01' = {
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.Storage/storageAccounts/advancedPlatformMetrics@2026-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    enabled: true
...
```bicep
resource exampleResource 'Microsoft.Storage/storageAccounts/blobServices@2026-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
PutContainers
```bicep
resource exampleResource 'Microsoft.Storage/storageAccounts/blobServices/containers@2026-06-01' = {
  parent: parentResource 
  name: 'example'
}
```
...
```bicep
resource exampleResource 'Microsoft.Storage/storageAccounts/blobServices/containers/immutabilityPolicies@2026-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    allowProtectedAppendWrites: true
...
CreateConnector
```bicep
resource exampleResource 'Microsoft.Storage/storageAccounts/connectors@2026-06-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
CreateDataShare
```bicep
resource exampleResource 'Microsoft.Storage/storageAccounts/dataShares@2026-06-01' = {
  parent: parentResource 
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Storage/storageAccounts/encryptionScopes@2026-06-01' = {
  parent: parentResource 
  name: 'example'
}
```
...
PutFileServices
```bicep
resource exampleResource 'Microsoft.Storage/storageAccounts/fileServices@2026-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    cors: {
...
Create NFS Shares
```bicep
resource exampleResource 'Microsoft.Storage/storageAccounts/fileServices/shares@2026-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Storage/storageAccounts/inventoryPolicies@2026-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    policy: {
...
CreateLocalUser
```bicep
resource exampleResource 'Microsoft.Storage/storageAccounts/localUsers@2026-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Storage/storageAccounts/managementPolicies@2026-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    policy: {
...
```bicep
resource exampleResource 'Microsoft.Storage/storageAccounts/objectReplicationPolicies@2026-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Storage/storageAccounts/privateEndpointConnections@2026-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
QueueServicesPut
```bicep
resource exampleResource 'Microsoft.Storage/storageAccounts/queueServices@2026-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    cors: {
...
QueueOperationPut
```bicep
resource exampleResource 'Microsoft.Storage/storageAccounts/queueServices/queues@2026-06-01' = {
  parent: parentResource 
  name: 'example'
}
```
...
```bicep
resource exampleResource 'Microsoft.Storage/storageAccounts/storageTaskAssignments@2026-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
TableServicesPut
```bicep
resource exampleResource 'Microsoft.Storage/storageAccounts/tableServices@2026-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    cors: {
...
```bicep
resource exampleResource 'Microsoft.Storage/storageAccounts/tableServices/tables@2026-06-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    signedIdentifiers: [
