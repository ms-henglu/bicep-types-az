...
## Resource Oracle.Database/cloudExadataInfrastructures/dbServers@2026-01-01-preview
* **Readable Scope(s)**: ResourceGroup
...
## Resource Oracle.Database/cloudVmClusters/dbNodes@2026-01-01-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2026-01-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Oracle.Database/exadbVmClusters/dbNodes@2026-01-01-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2026-01-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Oracle.Database/locations/autonomousDatabaseCharacterSets@2026-01-01-preview
...
## Resource Oracle.Database/locations/autonomousDatabaseNationalCharacterSets@2026-01-01-preview
* **Readable Scope(s)**: Subscription
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2026-01-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Oracle.Database/locations/autonomousDbVersions@2026-01-01-preview
* **Readable Scope(s)**: Subscription
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2026-01-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Oracle.Database/locations/dbSystemDbVersions@2026-01-01-preview
* **Readable Scope(s)**: Subscription
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2026-01-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Oracle.Database/locations/dbSystemShapes@2026-01-01-preview
* **Readable Scope(s)**: Subscription
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2026-01-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Oracle.Database/locations/dnsPrivateViews@2026-01-01-preview
* **Readable Scope(s)**: Subscription
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2026-01-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Oracle.Database/locations/dnsPrivateZones@2026-01-01-preview
* **Readable Scope(s)**: Subscription
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2026-01-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Oracle.Database/locations/flexComponents@2026-01-01-preview
* **Readable Scope(s)**: Subscription
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2026-01-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Oracle.Database/locations/giVersions@2026-01-01-preview
* **Readable Scope(s)**: Subscription
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2026-01-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Oracle.Database/locations/giVersions/giMinorVersions@2026-01-01-preview
* **Readable Scope(s)**: Subscription
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2026-01-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Oracle.Database/locations/systemVersions@2026-01-01-preview
* **Readable Scope(s)**: Subscription
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2026-01-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Function action (Oracle.Database/autonomousDatabases@2026-01-01-preview)
...
## Function action (Oracle.Database/cloudVmClusters/dbNodes@2026-01-01-preview)
* **Resource**: Oracle.Database/cloudVmClusters/dbNodes
* **ApiVersion**: 2026-01-01-preview
* **Input**: [DbNodeAction](#dbnodeaction)
* **Output**: [DbNode](#dbnode)

## Function action (Oracle.Database/exadbVmClusters/dbNodes@2026-01-01-preview)
* **Resource**: Oracle.Database/exadbVmClusters/dbNodes
* **ApiVersion**: 2026-01-01-preview
* **Input**: [DbNodeAction](#dbnodeaction)
* **Output**: [DbActionResponse](#dbactionresponse)

## Function addAzureSubscriptions (Oracle.Database/oracleSubscriptions@2026-01-01-preview)
* **Resource**: Oracle.Database/oracleSubscriptions
* **ApiVersion**: 2026-01-01-preview
* **Input**: [AzureSubscriptions](#azuresubscriptions)

## Function addStorageCapacity (Oracle.Database/cloudExadataInfrastructures@2026-01-01-preview)
* **Resource**: Oracle.Database/cloudExadataInfrastructures
* **ApiVersion**: 2026-01-01-preview
* **Output**: [CloudExadataInfrastructure](#cloudexadatainfrastructure)

## Function addVms (Oracle.Database/cloudVmClusters@2026-01-01-preview)
* **Resource**: Oracle.Database/cloudVmClusters
* **ApiVersion**: 2026-01-01-preview
* **Input**: [AddRemoveDbNode](#addremovedbnode)
* **Output**: [CloudVmCluster](#cloudvmcluster)

## Function changeDisasterRecoveryConfiguration (Oracle.Database/autonomousDatabases@2026-01-01-preview)
* **Resource**: Oracle.Database/autonomousDatabases
* **ApiVersion**: 2026-01-01-preview
* **Input**: [DisasterRecoveryConfigurationDetails](#disasterrecoveryconfigurationdetails)
* **Output**: [AutonomousDatabase](#autonomousdatabase)

## Function configureExascale (Oracle.Database/cloudExadataInfrastructures@2026-01-01-preview)
* **Resource**: Oracle.Database/cloudExadataInfrastructures
* **ApiVersion**: 2026-01-01-preview
* **Input**: [ConfigureExascaleCloudExadataInfrastructureDetails](#configureexascalecloudexadatainfrastructuredetails)
* **Output**: [CloudExadataInfrastructure](#cloudexadatainfrastructure)

## Function failover (Oracle.Database/autonomousDatabases@2026-01-01-preview)
* **Resource**: Oracle.Database/autonomousDatabases
* **ApiVersion**: 2026-01-01-preview
* **Input**: [PeerDbDetails](#peerdbdetails)
* **Output**: [AutonomousDatabase](#autonomousdatabase)

## Function generateWallet (Oracle.Database/autonomousDatabases@2026-01-01-preview)
* **Resource**: Oracle.Database/autonomousDatabases
* **ApiVersion**: 2026-01-01-preview
...
## Function removeVms (Oracle.Database/cloudVmClusters@2026-01-01-preview)
* **Resource**: Oracle.Database/cloudVmClusters
* **ApiVersion**: 2026-01-01-preview
* **Input**: [AddRemoveDbNode](#addremovedbnode)
* **Output**: [CloudVmCluster](#cloudvmcluster)

## Function removeVms (Oracle.Database/exadbVmClusters@2026-01-01-preview)
...
## Function restore (Oracle.Database/autonomousDatabases@2026-01-01-preview)
* **Resource**: Oracle.Database/autonomousDatabases
* **ApiVersion**: 2026-01-01-preview
* **Input**: [RestoreAutonomousDatabaseDetails](#restoreautonomousdatabasedetails)
* **Output**: [AutonomousDatabase](#autonomousdatabase)

## Function shrink (Oracle.Database/autonomousDatabases@2026-01-01-preview)
* **Resource**: Oracle.Database/autonomousDatabases
* **ApiVersion**: 2026-01-01-preview
* **Output**: [AutonomousDatabase](#autonomousdatabase)

## Function switchover (Oracle.Database/autonomousDatabases@2026-01-01-preview)
* **Resource**: Oracle.Database/autonomousDatabases
* **ApiVersion**: 2026-01-01-preview
* **Input**: [PeerDbDetails](#peerdbdetails)
* **Output**: [AutonomousDatabase](#autonomousdatabase)
