...
```bicep
resource exampleResource 'Oracle.Database/autonomousDatabases@2026-04-01-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
    adminPassword: '********'
...
resource exampleResource 'Oracle.Database/autonomousDatabases@2026-04-01-preview' = {
  ...
  properties: {
    ...
    characterSet: 'AL32UTF8'
    clusterPlacementGroupId: 'epfdoiycss'
    computeCount: 2
    computeModel: 'ECPU'
    connectionStrings: {
...
```bicep
resource exampleResource 'Oracle.Database/autonomousDatabases/autonomousDatabaseBackups@2026-04-01-preview' = {
...
```bicep
resource exampleResource 'Oracle.Database/cloudExadataInfrastructures@2026-04-01-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
    computeCount: 100
...
Create VM Cluster
```bicep
resource exampleResource 'Oracle.Database/cloudVmClusters@2026-04-01-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Oracle.Database/cloudVmClusters/virtualNetworkAddresses@2026-04-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Oracle.Database/dbSystems@2026-04-01-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
    adminPassword: '********'
...
```bicep
resource exampleResource 'Oracle.Database/exadbVmClusters@2026-04-01-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Oracle.Database/exascaleDbStorageVaults@2026-04-01-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Oracle.Database/goldenGateConnections@2026-04-01-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Oracle.Database/goldenGateDeployments@2026-04-01-preview' = {
  name: 'example'
  location: 'ngddrf'
  properties: {
    backupSchedule: {
...
```bicep
resource exampleResource 'Oracle.Database/networkAnchors@2026-04-01-preview' = {
  name: 'example'
  location: 'eastus'
  properties: {
    dnsForwardingRules: [
...
```bicep
resource exampleResource 'Oracle.Database/oracleSubscriptions@2026-04-01-preview' = {
  name: 'example'
  plan: {
    name: 'plan1'
    product: 'product1'
...
```bicep
resource exampleResource 'Oracle.Database/resourceAnchors@2026-04-01-preview' = {
  name: 'example'
  location: 'bg'
  properties: {
