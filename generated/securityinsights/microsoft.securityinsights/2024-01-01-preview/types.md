...
## Resource Microsoft.SecurityInsights/sourcecontrols@2024-01-01-preview
* **Valid Scope(s)**: Extension
### Properties
* **apiVersion**: '2024-01-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string: Etag of the azure resource
...
## Function alerts (Microsoft.SecurityInsights/incidents@2024-01-01-preview)
* **Resource**: Microsoft.SecurityInsights/incidents
* **ApiVersion**: 2024-01-01-preview
* **Output**: [IncidentAlertList](#incidentalertlist)

## Function appendTags (Microsoft.SecurityInsights/threatIntelligence/indicators@2024-01-01-preview)
...
## Function bookmarks (Microsoft.SecurityInsights/incidents@2024-01-01-preview)
* **Resource**: Microsoft.SecurityInsights/incidents
* **ApiVersion**: 2024-01-01-preview
* **Output**: [IncidentBookmarkList](#incidentbookmarklist)

## Function connect (Microsoft.SecurityInsights/dataConnectors@2024-01-01-preview)
* **Resource**: Microsoft.SecurityInsights/dataConnectors
* **ApiVersion**: 2024-01-01-preview
* **Input**: [DataConnectorConnectBody](#dataconnectorconnectbody)

## Function count (Microsoft.SecurityInsights/threatIntelligence@2024-01-01-preview)
* **Resource**: Microsoft.SecurityInsights/threatIntelligence
* **ApiVersion**: 2024-01-01-preview
* **Input**: [Query](#query)
* **Output**: [ThreatIntelligenceCount](#threatintelligencecount)

## Function createIndicator (Microsoft.SecurityInsights/threatIntelligence@2024-01-01-preview)
* **Resource**: Microsoft.SecurityInsights/threatIntelligence
* **ApiVersion**: 2024-01-01-preview
...
## Function createTeam (Microsoft.SecurityInsights/incidents@2024-01-01-preview)
* **Resource**: Microsoft.SecurityInsights/incidents
* **ApiVersion**: 2024-01-01-preview
* **Input**: [TeamInformation](#teaminformation)
* **Output**: [TeamInformation](#teaminformation)

## Function delete (Microsoft.SecurityInsights/sourcecontrols@2024-01-01-preview)
* **Resource**: Microsoft.SecurityInsights/sourcecontrols
* **ApiVersion**: 2024-01-01-preview
* **Input**: [RepositoryAccessProperties](#repositoryaccessproperties)
* **Output**: [Warning](#warning)

## Function disconnect (Microsoft.SecurityInsights/dataConnectors@2024-01-01-preview)
* **Resource**: Microsoft.SecurityInsights/dataConnectors
* **ApiVersion**: 2024-01-01-preview

## Function entities (Microsoft.SecurityInsights/incidents@2024-01-01-preview)
* **Resource**: Microsoft.SecurityInsights/incidents
* **ApiVersion**: 2024-01-01-preview
* **Output**: [IncidentEntitiesResponse](#incidententitiesresponse)

## Function expand (Microsoft.SecurityInsights/entities@2024-01-01-preview)
...
## Function expand (Microsoft.SecurityInsights/bookmarks@2024-01-01-preview)
...
## Function getInsights (Microsoft.SecurityInsights/entities@2024-01-01-preview)
* **Resource**: Microsoft.SecurityInsights/entities
* **ApiVersion**: 2024-01-01-preview
* **Input**: [EntityGetInsightsParameters](#entitygetinsightsparameters)
* **Output**: [EntityGetInsightsResponse](#entitygetinsightsresponse)

## Function getTimeline (Microsoft.SecurityInsights/entities@2024-01-01-preview)
* **Resource**: Microsoft.SecurityInsights/entities
* **ApiVersion**: 2024-01-01-preview
* **Input**: [EntityTimelineParameters](#entitytimelineparameters)
* **Output**: [EntityTimelineResponse](#entitytimelineresponse)

## Function jobs (Microsoft.SecurityInsights/workspaceManagerAssignments@2024-01-01-preview)
...
## Function query (Microsoft.SecurityInsights/threatIntelligence@2024-01-01-preview)
* **Resource**: Microsoft.SecurityInsights/threatIntelligence
* **ApiVersion**: 2024-01-01-preview
* **Input**: [QueryAutoGenerated](#queryautogenerated)
* **Output**: [ThreatIntelligenceList](#threatintelligencelist)

## Function queryIndicators (Microsoft.SecurityInsights/threatIntelligence@2024-01-01-preview)
* **Resource**: Microsoft.SecurityInsights/threatIntelligence
* **ApiVersion**: 2024-01-01-preview
...
## Function replaceTags (Microsoft.SecurityInsights/threatIntelligence/indicators@2024-01-01-preview)
* **Resource**: Microsoft.SecurityInsights/threatIntelligence/indicators
* **ApiVersion**: 2024-01-01-preview
* **Input**: [ThreatIntelligenceIndicatorModel](#threatintelligenceindicatormodel)
* **Output**: [ThreatIntelligenceInformation](#threatintelligenceinformation)

## Function runPlaybook (Microsoft.SecurityInsights/entities@2024-01-01-preview)
* **Resource**: Microsoft.SecurityInsights/entities
* **ApiVersion**: 2024-01-01-preview
* **Input**: [EntityManualTriggerRequestBody](#entitymanualtriggerrequestbody)

## Function runPlaybook (Microsoft.SecurityInsights/incidents@2024-01-01-preview)
* **Resource**: Microsoft.SecurityInsights/incidents
* **ApiVersion**: 2024-01-01-preview
* **Input**: [ManualTriggerRequestBody](#manualtriggerrequestbody)

## Function triggerEvaluation (Microsoft.SecurityInsights/recommendations@2024-01-01-preview)
* **Resource**: Microsoft.SecurityInsights/recommendations
* **ApiVersion**: 2024-01-01-preview
* **Output**: [ReevaluateResponse](#reevaluateresponse)

## Function triggerRuleRun (Microsoft.SecurityInsights/alertRules@2024-01-01-preview)
...
### Properties
* **createdBy**: [UserInfoAutoGenerated](#userinfoautogenerated) (ReadOnly): The UserInfo of the user/entity which originally created this TI object.
...
* **lastModifiedBy**: [UserInfoAutoGenerated](#userinfoautogenerated) (ReadOnly): The UserInfo of the user/entity which last modified this TI object.
...
## UserInfoAutoGenerated
### Properties
* **email**: string: The user's email address.
* **name**: string: The user's name.
* **objectId**: string {minLength: 36, maxLength: 36, pattern: "^[0-9a-fA-F]{8}-([0-9a-fA-F]{4}-){3}[0-9a-fA-F]{12}$"} (ReadOnly): The user's object ID.
