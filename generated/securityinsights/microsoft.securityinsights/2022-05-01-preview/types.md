...
## Resource Microsoft.SecurityInsights/alertRuleTemplates@2022-05-01-preview
* **Readable Scope(s)**: Extension
...
## Resource Microsoft.SecurityInsights/entities@2022-05-01-preview
* **Readable Scope(s)**: Extension
* **Writable Scope(s)**: None
* **Discriminator**: kind
...
## Resource Microsoft.SecurityInsights/entities/relations@2022-05-01-preview
* **Readable Scope(s)**: Extension
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2022-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.SecurityInsights/entityQueryTemplates@2022-05-01-preview
* **Readable Scope(s)**: Extension
* **Writable Scope(s)**: None
* **Discriminator**: kind
...
## Resource Microsoft.SecurityInsights/officeConsents@2022-05-01-preview
* **Readable Scope(s)**: Extension
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2022-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.SecurityInsights/sourcecontrols@2022-05-01-preview
* **Readable Scope(s)**: Extension
* **Writable Scope(s)**: Extension
### Properties
* **apiVersion**: '2022-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Function alerts (Microsoft.SecurityInsights/incidents@2022-05-01-preview)
* **Resource**: Microsoft.SecurityInsights/incidents
* **ApiVersion**: 2022-05-01-preview
* **Output**: [IncidentAlertList](#incidentalertlist)

## Function appendTags (Microsoft.SecurityInsights/threatIntelligence/indicators@2022-05-01-preview)
...
## Function bookmarks (Microsoft.SecurityInsights/incidents@2022-05-01-preview)
* **Resource**: Microsoft.SecurityInsights/incidents
* **ApiVersion**: 2022-05-01-preview
* **Output**: [IncidentBookmarkList](#incidentbookmarklist)

## Function connect (Microsoft.SecurityInsights/dataConnectors@2022-05-01-preview)
* **Resource**: Microsoft.SecurityInsights/dataConnectors
* **ApiVersion**: 2022-05-01-preview
* **Input**: [DataConnectorConnectBody](#dataconnectorconnectbody)

## Function createIndicator (Microsoft.SecurityInsights/threatIntelligence@2022-05-01-preview)
...
## Function createTeam (Microsoft.SecurityInsights/incidents@2022-05-01-preview)
* **Resource**: Microsoft.SecurityInsights/incidents
* **ApiVersion**: 2022-05-01-preview
* **Input**: [TeamProperties](#teamproperties)
* **Output**: [TeamInformation](#teaminformation)

## Function disconnect (Microsoft.SecurityInsights/dataConnectors@2022-05-01-preview)
* **Resource**: Microsoft.SecurityInsights/dataConnectors
* **ApiVersion**: 2022-05-01-preview

## Function entities (Microsoft.SecurityInsights/incidents@2022-05-01-preview)
* **Resource**: Microsoft.SecurityInsights/incidents
* **ApiVersion**: 2022-05-01-preview
* **Output**: [IncidentEntitiesResponse](#incidententitiesresponse)

## Function expand (Microsoft.SecurityInsights/bookmarks@2022-05-01-preview)
...
## Function expand (Microsoft.SecurityInsights/entities@2022-05-01-preview)
...
## Function getInsights (Microsoft.SecurityInsights/entities@2022-05-01-preview)
* **Resource**: Microsoft.SecurityInsights/entities
* **ApiVersion**: 2022-05-01-preview
* **Input**: [EntityGetInsightsParameters](#entitygetinsightsparameters)
* **Output**: [EntityGetInsightsResponse](#entitygetinsightsresponse)

## Function getTimeline (Microsoft.SecurityInsights/entities@2022-05-01-preview)
* **Resource**: Microsoft.SecurityInsights/entities
* **ApiVersion**: 2022-05-01-preview
* **Input**: [EntityTimelineParameters](#entitytimelineparameters)
* **Output**: [EntityTimelineResponse](#entitytimelineresponse)

## Function queryIndicators (Microsoft.SecurityInsights/threatIntelligence@2022-05-01-preview)
* **Resource**: Microsoft.SecurityInsights/threatIntelligence
* **ApiVersion**: 2022-05-01-preview
...
## Function replaceTags (Microsoft.SecurityInsights/threatIntelligence/indicators@2022-05-01-preview)
* **Resource**: Microsoft.SecurityInsights/threatIntelligence/indicators
* **ApiVersion**: 2022-05-01-preview
* **Input**: [ThreatIntelligenceIndicatorModel](#threatintelligenceindicatormodel)
* **Output**: [ThreatIntelligenceInformation](#threatintelligenceinformation)

## Function runPlaybook (Microsoft.SecurityInsights/incidents@2022-05-01-preview)
* **Resource**: Microsoft.SecurityInsights/incidents
* **ApiVersion**: 2022-05-01-preview
...
## TeamProperties
### Properties
* **groupIds**: (string {minLength: 36, maxLength: 36, pattern: "^[0-9a-fA-F]{8}-([0-9a-fA-F]{4}-){3}[0-9a-fA-F]{12}$"})[]: List of group IDs to add their members to the team
* **memberIds**: (string {minLength: 36, maxLength: 36, pattern: "^[0-9a-fA-F]{8}-([0-9a-fA-F]{4}-){3}[0-9a-fA-F]{12}$"})[]: List of member IDs to add to the team
