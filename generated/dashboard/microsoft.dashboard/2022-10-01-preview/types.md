...
## Resource Microsoft.Dashboard/grafana/privateLinkResources@2022-10-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2022-10-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Function checkEnterpriseDetails (Microsoft.Dashboard/grafana@2022-10-01-preview)
* **Resource**: Microsoft.Dashboard/grafana
* **ApiVersion**: 2022-10-01-preview
* **Output**: [EnterpriseDetails](#enterprisedetails)

## Function fetchAvailablePlugins (Microsoft.Dashboard/grafana@2022-10-01-preview)
* **Resource**: Microsoft.Dashboard/grafana
* **ApiVersion**: 2022-10-01-preview
...
* **password**: string: Password of SMTP auth. If the password contains # or ;, then you have to wrap it with triple quotes
