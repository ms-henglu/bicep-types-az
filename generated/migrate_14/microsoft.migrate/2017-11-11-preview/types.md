# Microsoft.Migrate @ 2017-11-11-preview

## Resource Microsoft.Migrate/projects@2017-11-11-preview
...
## Resource Microsoft.Migrate/projects/groups@2017-11-11-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2017-11-11-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **eTag**: string: For optimistic concurrency control.
...
## Resource Microsoft.Migrate/projects/groups/assessments@2017-11-11-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2017-11-11-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **eTag**: string: For optimistic concurrency control.
...
## Resource Microsoft.Migrate/projects/groups/assessments/assessedMachines@2017-11-11-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2017-11-11-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Migrate/projects/machines@2017-11-11-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2017-11-11-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **eTag**: string (ReadOnly): For optimistic concurrency control.
...
* **suitability**: 'ConditionallySuitable' | 'NotSuitable' | 'Suitable' | 'Unknown' | string (ReadOnly): Whether this disk is suitable for Azure.
...
* **suitability**: 'ConditionallySuitable' | 'NotSuitable' | 'Suitable' | 'Unknown' | string (ReadOnly): Whether machine is suitable for migration to Azure.
* **suitabilityExplanation**: 'BootTypeNotSupported' | 'CheckCentOsVersion' | 'CheckCoreOsLinuxVersion' | 'CheckDebianLinuxVersion' | 'CheckOpenSuseLinuxVersion' | 'CheckOracleLinuxVersion' | 'CheckRedHatLinuxVersion' | 'CheckSuseLinuxVersion' | 'CheckUbuntuLinuxVersion' | 'CheckWindowsServer2008R2Version' | 'GuestOperatingSystemArchitectureNotSupported' | 'GuestOperatingSystemNotSupported' | 'InternalErrorOccuredDuringComputeEvaluation' | 'InternalErrorOccuredDuringNetworkEvaluation' | 'InternalErrorOccuredDuringStorageEvaluation' | 'MoreDisksThanSupported' | 'NoGuestOperatingSystemConditionallySupported' | 'NoSuitableVmSizeFound' | 'NoVmSizeForSelectedAzureLocation' | 'NoVmSizeForSelectedPricingTier' | 'NoVmSizeSupportsNetworkPerformance' | 'NoVmSizeSupportsStoragePerformance' | 'NotApplicable' | 'OneOrMoreAdaptersNotSuitable' | 'OneOrMoreDisksNotSuitable' | 'Unknown' | 'WindowsClientVersionsConditionallySupported' | 'WindowsServerVersionConditionallySupported' | string (ReadOnly): If machine is not ready to be migrated, this explains the reasons and mitigation steps.
...
* **suitability**: 'ConditionallySuitable' | 'NotSuitable' | 'Suitable' | 'Unknown' | string (ReadOnly): Whether this adapter is suitable for Azure.
...
* **azureLocation**: 'AustraliaEast' | 'AustraliaSoutheast' | 'BrazilSouth' | 'CanadaCentral' | 'CanadaEast' | 'CentralIndia' | 'CentralUs' | 'EastAsia' | 'EastUs' | 'EastUs2' | 'JapanEast' | 'JapanWest' | 'KoreaCentral' | 'KoreaSouth' | 'NorthCentralUs' | 'NorthEurope' | 'SouthCentralUs' | 'SouthIndia' | 'SoutheastAsia' | 'UkSouth' | 'UkWest' | 'Unknown' | 'WestCentralUs' | 'WestEurope' | 'WestIndia' | 'WestUs' | 'WestUs2' | string (Required): Target Azure location for which the machines should be assessed. These enums are the same as used by Compute API.
* **azureOfferCode**: 'MSAZR0003P' | 'MSAZR0022P' | 'MSAZR0023P' | 'MSAZR0025P' | 'MSAZR0029P' | 'MSAZR0036P' | 'MSAZR0044P' | 'MSAZR0059P' | 'MSAZR0060P' | 'MSAZR0062P' | 'MSAZR0063P' | 'MSAZR0064P' | 'MSAZR0111P' | 'MSAZR0120P' | 'MSAZR0121P' | 'MSAZR0122P' | 'MSAZR0123P' | 'MSAZR0124P' | 'MSAZR0125P' | 'MSAZR0126P' | 'MSAZR0127P' | 'MSAZR0128P' | 'MSAZR0129P' | 'MSAZR0130P' | 'MSAZR0144P' | 'MSAZR0148P' | 'MSAZR0149P' | 'Unknown' | string (Required): Offer code according to which cost estimation is done.
...
* **currency**: 'ARS' | 'AUD' | 'BRL' | 'CAD' | 'CHF' | 'DKK' | 'EUR' | 'GBP' | 'HKD' | 'IDR' | 'INR' | 'JPY' | 'KRW' | 'MXN' | 'MYR' | 'NOK' | 'NZD' | 'RUB' | 'SAR' | 'SEK' | 'TRY' | 'TWD' | 'USD' | 'Unknown' | 'ZAR' | string (Required): Currency to report prices in.
