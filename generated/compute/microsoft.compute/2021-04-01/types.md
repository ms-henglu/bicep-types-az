...
* **supportedCapabilities**: [SupportedCapabilities](#supportedcapabilities): List of supported capabilities (like accelerated networking) persisted on the disk resource for VM use.
...
## CreationData
### Properties
* **createOption**: 'Attach' | 'Copy' | 'CopyStart' | 'Empty' | 'FromImage' | 'Import' | 'Restore' | 'Upload' (Required): This enumerates the possible sources of a disk's creation.
...
## DiskSecurityProfile
### Properties
* **securityType**: 'TrustedLaunch': Specifies the SecurityType of the VM. Applicable for OS disks only.
