# Microsoft.Cache @ 2023-03-01-preview

## Resource Microsoft.Cache/redisEnterprise@2023-03-01-preview
...
## Resource Microsoft.Cache/redisEnterprise/databases@2023-03-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2023-03-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Cache/redisEnterprise/privateEndpointConnections@2023-03-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2023-03-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Function export (Microsoft.Cache/redisEnterprise/databases@2023-03-01-preview)
* **Resource**: Microsoft.Cache/redisEnterprise/databases
* **ApiVersion**: 2023-03-01-preview
* **Input**: [ExportClusterParameters](#exportclusterparameters)

## Function flush (Microsoft.Cache/redisEnterprise/databases@2023-03-01-preview)
* **Resource**: Microsoft.Cache/redisEnterprise/databases
* **ApiVersion**: 2023-03-01-preview
* **Input**: [FlushParameters](#flushparameters)

## Function forceUnlink (Microsoft.Cache/redisEnterprise/databases@2023-03-01-preview)
* **Resource**: Microsoft.Cache/redisEnterprise/databases
* **ApiVersion**: 2023-03-01-preview
* **Input**: [ForceUnlinkParameters](#forceunlinkparameters)

## Function import (Microsoft.Cache/redisEnterprise/databases@2023-03-01-preview)
* **Resource**: Microsoft.Cache/redisEnterprise/databases
* **ApiVersion**: 2023-03-01-preview
* **Input**: [ImportClusterParameters](#importclusterparameters)

## Function listKeys (Microsoft.Cache/redisEnterprise/databases@2023-03-01-preview)
* **Resource**: Microsoft.Cache/redisEnterprise/databases
* **ApiVersion**: 2023-03-01-preview
* **Output**: [AccessKeys](#accesskeys)

## Function regenerateKey (Microsoft.Cache/redisEnterprise/databases@2023-03-01-preview)
* **Resource**: Microsoft.Cache/redisEnterprise/databases
* **ApiVersion**: 2023-03-01-preview
...
## FlushParameters
### Properties
* **ids**: string[]: The resource identifiers of all the other database resources in the georeplication group to be flushed
