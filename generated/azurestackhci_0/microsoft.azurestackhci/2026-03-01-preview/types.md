...
## Resource Microsoft.AzureStackHCI/clusters/publishers@2026-03-01-preview
* **Readable Scope(s)**: ResourceGroup
...
## Resource Microsoft.AzureStackHCI/clusters/publishers/offers@2026-03-01-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2026-03-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.AzureStackHCI/clusters/publishers/offers/skus@2026-03-01-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2026-03-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.AzureStackHCI/locations/osImages@2026-03-01-preview
...
## Resource Microsoft.AzureStackHCI/locations/platformUpdates@2026-03-01-preview
* **Readable Scope(s)**: Subscription
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2026-03-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.AzureStackHCI/locations/updateContents@2026-03-01-preview
* **Readable Scope(s)**: Subscription
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2026-03-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.AzureStackHCI/locations/validatedSolutionRecipes@2026-03-01-preview
* **Readable Scope(s)**: Subscription
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2026-03-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Function apply (Microsoft.AzureStackHCI/clusters/updates@2026-03-01-preview)
* **Resource**: Microsoft.AzureStackHCI/clusters/updates
* **ApiVersion**: 2026-03-01-preview

## Function changeRing (Microsoft.AzureStackHCI/clusters@2026-03-01-preview)
* **Resource**: Microsoft.AzureStackHCI/clusters
* **ApiVersion**: 2026-03-01-preview
* **Input**: [ChangeRingRequest](#changeringrequest)
* **Output**: [Cluster](#cluster)

## Function checkHealth (Microsoft.AzureStackHCI/clusters/updateSummaries@2026-03-01-preview)
* **Resource**: Microsoft.AzureStackHCI/clusters/updateSummaries
* **ApiVersion**: 2026-03-01-preview

## Function checkUpdates (Microsoft.AzureStackHCI/clusters/updateSummaries@2026-03-01-preview)
* **Resource**: Microsoft.AzureStackHCI/clusters/updateSummaries
* **ApiVersion**: 2026-03-01-preview
* **Input**: [CheckUpdatesRequest](#checkupdatesrequest)

## Function claimDevices (Microsoft.AzureStackHCI/devicePools@2026-03-01-preview)
* **Resource**: Microsoft.AzureStackHCI/devicePools
* **ApiVersion**: 2026-03-01-preview
* **Input**: [ClaimDeviceRequest](#claimdevicerequest)

## Function configureRemoteSupport (Microsoft.AzureStackHCI/clusters@2026-03-01-preview)
* **Resource**: Microsoft.AzureStackHCI/clusters
* **ApiVersion**: 2026-03-01-preview
* **Input**: [RemoteSupportRequest](#remotesupportrequest)
* **Output**: [Cluster](#cluster)

## Function consentAndInstallDefaultExtensions (Microsoft.AzureStackHCI/clusters/arcSettings@2026-03-01-preview)
* **Resource**: Microsoft.AzureStackHCI/clusters/arcSettings
* **ApiVersion**: 2026-03-01-preview
* **Output**: [ArcSetting](#arcsetting)

## Function createArcIdentity (Microsoft.AzureStackHCI/clusters/arcSettings@2026-03-01-preview)
* **Resource**: Microsoft.AzureStackHCI/clusters/arcSettings
* **ApiVersion**: 2026-03-01-preview
* **Output**: [ArcIdentityResponse](#arcidentityresponse)

## Function createClusterIdentity (Microsoft.AzureStackHCI/clusters@2026-03-01-preview)
* **Resource**: Microsoft.AzureStackHCI/clusters
* **ApiVersion**: 2026-03-01-preview
* **Output**: [ClusterIdentityResponse](#clusteridentityresponse)

## Function extendSoftwareAssuranceBenefit (Microsoft.AzureStackHCI/clusters@2026-03-01-preview)
* **Resource**: Microsoft.AzureStackHCI/clusters
* **ApiVersion**: 2026-03-01-preview
* **Input**: [SoftwareAssuranceChangeRequest](#softwareassurancechangerequest)
* **Output**: [Cluster](#cluster)

## Function generatePassword (Microsoft.AzureStackHCI/clusters/arcSettings@2026-03-01-preview)
* **Resource**: Microsoft.AzureStackHCI/clusters/arcSettings
* **ApiVersion**: 2026-03-01-preview
* **Output**: [PasswordCredential](#passwordcredential)

## Function initializeDisableProcess (Microsoft.AzureStackHCI/clusters/arcSettings@2026-03-01-preview)
* **Resource**: Microsoft.AzureStackHCI/clusters/arcSettings
* **ApiVersion**: 2026-03-01-preview

## Function prepare (Microsoft.AzureStackHCI/clusters/updates@2026-03-01-preview)
* **Resource**: Microsoft.AzureStackHCI/clusters/updates
* **ApiVersion**: 2026-03-01-preview

## Function reconcile (Microsoft.AzureStackHCI/clusters/arcSettings@2026-03-01-preview)
* **Resource**: Microsoft.AzureStackHCI/clusters/arcSettings
* **ApiVersion**: 2026-03-01-preview
* **Input**: [ReconcileArcSettingsRequest](#reconcilearcsettingsrequest)
* **Output**: [ArcSetting](#arcsetting)

## Function releaseDevices (Microsoft.AzureStackHCI/devicePools@2026-03-01-preview)
* **Resource**: Microsoft.AzureStackHCI/devicePools
* **ApiVersion**: 2026-03-01-preview
* **Input**: [ReleaseDeviceRequest](#releasedevicerequest)

## Function triggerLogCollection (Microsoft.AzureStackHCI/clusters@2026-03-01-preview)
* **Resource**: Microsoft.AzureStackHCI/clusters
* **ApiVersion**: 2026-03-01-preview
* **Input**: [LogCollectionRequest](#logcollectionrequest)
* **Output**: [Cluster](#cluster)

## Function updateSecretsLocations (Microsoft.AzureStackHCI/clusters@2026-03-01-preview)
* **Resource**: Microsoft.AzureStackHCI/clusters
* **ApiVersion**: 2026-03-01-preview
* **Input**: [SecretsLocationsChangeRequest](#secretslocationschangerequest)
* **Output**: [Cluster](#cluster)

## Function upgrade (Microsoft.AzureStackHCI/clusters/arcSettings/extensions@2026-03-01-preview)
...
## Function uploadCertificate (Microsoft.AzureStackHCI/clusters@2026-03-01-preview)
* **Resource**: Microsoft.AzureStackHCI/clusters
* **ApiVersion**: 2026-03-01-preview
* **Input**: [UploadCertificateRequest](#uploadcertificaterequest)

## Function validate (Microsoft.AzureStackHCI/edgeDevices@2026-03-01-preview)
...
## Function validateOwnershipVouchers (Microsoft.AzureStackHCI/locations@2026-03-01-preview)
