...
Create cluster
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters@2026-10-01' = {
  name: 'example'
  identity: {
    type: 'SystemAssigned'
  }
...
Create ArcSetting
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters/arcSettings@2026-10-01' = {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters/arcSettings/extensions@2026-10-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    extensionParameters: {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters/deploymentSettings@2026-10-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    arcNodeResourceIds: [
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters/jobs@2026-10-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters/securitySettings@2026-10-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters/updates@2026-10-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters/updates/updateRuns@2026-10-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    progress: {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/clusters/updateSummaries@2026-10-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/edgeDevices@2026-10-01' = {
  name: 'example'
  kind: 'HCI'
  properties: {
    deviceConfiguration: {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/edgeDevices/jobs@2026-10-01' = {
  parent: parentResource 
  name: 'example'
  kind: 'HCI'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/edgeMachines@2026-10-01' = {
  name: 'example'
  location: 'eastus'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/edgeMachines/deploymentSettings@2026-10-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    deploymentConfiguration: {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/edgeMachines/disks@2026-10-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    diskConfiguration: {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/edgeMachines/disks/jobs@2026-10-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    path: '/data'
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/edgeMachines/disks/privilegedJobs@2026-10-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/edgeMachines/jobs@2026-10-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/edgeMachines/networkAdapters/jobs@2026-10-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    deploymentMode: 'Deploy'
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/edgeMachines/securitySettings@2026-10-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
  }
...
```bicep
resource exampleResource 'Microsoft.AzureStackHCI/edgeMachines/volumes@2026-10-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    volumeConfiguration: {
