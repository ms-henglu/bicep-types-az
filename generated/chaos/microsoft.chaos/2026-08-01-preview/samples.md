...
```bicep
resource exampleResource 'Microsoft.Chaos/experiments@2026-08-01-preview' = {
  name: 'example'
  identity: {
    type: 'SystemAssigned'
  }
...
```bicep
resource exampleResource 'Microsoft.Chaos/privateAccesses@2026-08-01-preview' = {
  name: 'example'
...
```bicep
resource exampleResource 'Microsoft.Chaos/targets@2026-08-01-preview' = {
  name: 'example'
  properties: {
  }
}
...
```bicep
resource exampleResource 'Microsoft.Chaos/targets/capabilities@2026-08-01-preview' = {
...
```bicep
resource exampleResource 'Microsoft.Chaos/workspaces@2026-08-01-preview' = {
  name: 'example'
  identity: {
    type: 'UserAssigned'
...
## microsoft.chaos/workspaces/connections

Create or update a connection.
```bicep
resource exampleResource 'Microsoft.Chaos/workspaces/connections@2026-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    kind: 'AksExtension'
    principalId: '00000000-0000-0000-0000-000000000000'
    targetResourceId: '/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/exampleRG/providers/Microsoft.ContainerService/managedClusters/exampleCluster'
...
```bicep
resource exampleResource 'Microsoft.Chaos/workspaces/scenarios@2026-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Chaos/workspaces/scenarios/configurations@2026-08-01-preview' = {
  parent: parentResource 
  name: 'example'
  properties: {
    parameters: [
