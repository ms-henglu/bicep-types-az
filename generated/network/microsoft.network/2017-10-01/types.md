...
## Resource Microsoft.Network/applicationGatewayAvailableSslOptions@2017-10-01 (ReadOnly)
...
## Resource Microsoft.Network/applicationGatewayAvailableSslOptions/predefinedPolicies@2017-10-01 (ReadOnly)
* **Valid Scope(s)**: Subscription
### Properties
* **apiVersion**: '2017-10-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Network/loadBalancers/backendAddressPools@2017-10-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2017-10-01' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): A unique read-only string that changes whenever the resource is updated.
...
## Resource Microsoft.Network/loadBalancers/frontendIPConfigurations@2017-10-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2017-10-01' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): A unique read-only string that changes whenever the resource is updated.
...
## Resource Microsoft.Network/loadBalancers/loadBalancingRules@2017-10-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2017-10-01' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): A unique read-only string that changes whenever the resource is updated.
...
## Resource Microsoft.Network/loadBalancers/probes@2017-10-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2017-10-01' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): A unique read-only string that changes whenever the resource is updated.
...
## Resource Microsoft.Network/networkInterfaces/ipConfigurations@2017-10-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2017-10-01' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): A unique read-only string that changes whenever the resource is updated.
...
## Resource Microsoft.Network/networkSecurityGroups/defaultSecurityRules@2017-10-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2017-10-01' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): A unique read-only string that changes whenever the resource is updated.
...
## Function availableProvidersList (Microsoft.Network/networkWatchers@2017-10-01)
...
## Function azureReachabilityReport (Microsoft.Network/networkWatchers@2017-10-01)
* **Resource**: Microsoft.Network/networkWatchers
* **ApiVersion**: 2017-10-01
...
## Function effectiveRouteTable (Microsoft.Network/networkInterfaces@2017-10-01)
* **Resource**: Microsoft.Network/networkInterfaces
* **ApiVersion**: 2017-10-01
* **Output**: [EffectiveRouteListResult](#effectiveroutelistresult)

## Function generatevpnclientpackage (Microsoft.Network/virtualNetworkGateways@2017-10-01)
* **Resource**: Microsoft.Network/virtualNetworkGateways
* **ApiVersion**: 2017-10-01
* **Input**: [VpnClientParameters](#vpnclientparameters)
* **Output**: string

## Function generatevpnprofile (Microsoft.Network/virtualNetworkGateways@2017-10-01)
* **Resource**: Microsoft.Network/virtualNetworkGateways
* **ApiVersion**: 2017-10-01
* **Input**: [VpnClientParameters](#vpnclientparameters)
* **Output**: string

## Function getAdvertisedRoutes (Microsoft.Network/virtualNetworkGateways@2017-10-01)
* **Resource**: Microsoft.Network/virtualNetworkGateways
* **ApiVersion**: 2017-10-01
* **Output**: [GatewayRouteListResult](#gatewayroutelistresult)

## Function getBgpPeerStatus (Microsoft.Network/virtualNetworkGateways@2017-10-01)
* **Resource**: Microsoft.Network/virtualNetworkGateways
* **ApiVersion**: 2017-10-01
* **Output**: [BgpPeerStatusListResult](#bgppeerstatuslistresult)

## Function getLearnedRoutes (Microsoft.Network/virtualNetworkGateways@2017-10-01)
* **Resource**: Microsoft.Network/virtualNetworkGateways
* **ApiVersion**: 2017-10-01
* **Output**: [GatewayRouteListResult](#gatewayroutelistresult)

## Function getvpnprofilepackageurl (Microsoft.Network/virtualNetworkGateways@2017-10-01)
* **Resource**: Microsoft.Network/virtualNetworkGateways
* **ApiVersion**: 2017-10-01
* **Output**: string

## Function ipFlowVerify (Microsoft.Network/networkWatchers@2017-10-01)
* **Resource**: Microsoft.Network/networkWatchers
* **ApiVersion**: 2017-10-01
* **Input**: [VerificationIPFlowParameters](#verificationipflowparameters)
* **Output**: [VerificationIPFlowResult](#verificationipflowresult)

## Function nextHop (Microsoft.Network/networkWatchers@2017-10-01)
* **Resource**: Microsoft.Network/networkWatchers
* **ApiVersion**: 2017-10-01
* **Input**: [NextHopParameters](#nexthopparameters)
* **Output**: [NextHopResult](#nexthopresult)

## Function query (Microsoft.Network/networkWatchers/connectionMonitors@2017-10-01)
...
## Function queryFlowLogStatus (Microsoft.Network/networkWatchers@2017-10-01)
* **Resource**: Microsoft.Network/networkWatchers
* **ApiVersion**: 2017-10-01
* **Input**: [FlowLogStatusParameters](#flowlogstatusparameters)
* **Output**: [FlowLogInformation](#flowloginformation)

## Function queryStatus (Microsoft.Network/networkWatchers/packetCaptures@2017-10-01)
...
## Function queryTroubleshootResult (Microsoft.Network/networkWatchers@2017-10-01)
* **Resource**: Microsoft.Network/networkWatchers
* **ApiVersion**: 2017-10-01
* **Input**: [QueryTroubleshootingParameters](#querytroubleshootingparameters)
* **Output**: [TroubleshootingResult](#troubleshootingresult)

## Function reset (Microsoft.Network/virtualNetworkGateways@2017-10-01)
* **Resource**: Microsoft.Network/virtualNetworkGateways
* **ApiVersion**: 2017-10-01
* **Output**: [VirtualNetworkGateway](#virtualnetworkgateway)

## Function securityGroupView (Microsoft.Network/networkWatchers@2017-10-01)
* **Resource**: Microsoft.Network/networkWatchers
* **ApiVersion**: 2017-10-01
* **Input**: [SecurityGroupViewParameters](#securitygroupviewparameters)
* **Output**: [SecurityGroupViewResult](#securitygroupviewresult)

## Function start (Microsoft.Network/applicationGateways@2017-10-01)
* **Resource**: Microsoft.Network/applicationGateways
* **ApiVersion**: 2017-10-01

## Function start (Microsoft.Network/networkWatchers/connectionMonitors@2017-10-01)
* **Resource**: Microsoft.Network/networkWatchers/connectionMonitors
* **ApiVersion**: 2017-10-01

## Function stop (Microsoft.Network/applicationGateways@2017-10-01)
* **Resource**: Microsoft.Network/applicationGateways
* **ApiVersion**: 2017-10-01

## Function stop (Microsoft.Network/networkWatchers/packetCaptures@2017-10-01)
* **Resource**: Microsoft.Network/networkWatchers/packetCaptures
* **ApiVersion**: 2017-10-01

## Function stop (Microsoft.Network/networkWatchers/connectionMonitors@2017-10-01)
* **Resource**: Microsoft.Network/networkWatchers/connectionMonitors
* **ApiVersion**: 2017-10-01

## Function supportedvpndevices (Microsoft.Network/virtualNetworkGateways@2017-10-01)
* **Resource**: Microsoft.Network/virtualNetworkGateways
* **ApiVersion**: 2017-10-01
* **Output**: string

## Function topology (Microsoft.Network/networkWatchers@2017-10-01)
* **Resource**: Microsoft.Network/networkWatchers
* **ApiVersion**: 2017-10-01
* **Input**: [TopologyParameters](#topologyparameters)
* **Output**: [Topology](#topology)

## Function troubleshoot (Microsoft.Network/networkWatchers@2017-10-01)
* **Resource**: Microsoft.Network/networkWatchers
* **ApiVersion**: 2017-10-01
* **Input**: [TroubleshootingParameters](#troubleshootingparameters)
* **Output**: [TroubleshootingResult](#troubleshootingresult)

## Function vpndeviceconfigurationscript (Microsoft.Network/connections@2017-10-01)
