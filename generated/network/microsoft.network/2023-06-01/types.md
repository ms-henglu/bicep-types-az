...
* **port**: int: Custom port which will be used for probing the backend servers. The valid value ranges from 1 to 65535. In case not set, port from http settings will be used. This property is valid for Basic, Standard_v2 and WAF_v2 only.
* **protocol**: 'Http' | 'Https' | 'Tcp' | 'Tls' | string: The protocol used for the probe.
...
### Properties
* **durationInSeconds**: int: Duration of packet capture in seconds.
...
* **numberOfPacketsToCapture**: int: Number of packets to be captured.
...
## HopLinkProperties
### Properties
* **roundTripTimeAvg**: int (ReadOnly): Average roundtrip time in milliseconds.
* **roundTripTimeMax**: int (ReadOnly): Maximum roundtrip time in milliseconds.
* **roundTripTimeMin**: int (ReadOnly): Minimum roundtrip time in milliseconds.
...
### Properties
* **minCapacity**: int: The minimum number of scale units for VirtualHub Router.
