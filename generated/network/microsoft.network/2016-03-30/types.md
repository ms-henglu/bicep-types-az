...
* **probe**: [SubResource](#subresource): Gets or sets probe resource of application gateway
...
### Properties
* **backendAddressPool**: [SubResource](#subresource): Gets or sets backend address pool resource of URL path map
* **backendHttpSettings**: [SubResource](#subresource): Gets or sets backend http settings resource of URL path map
...
* **urlPathMap**: [SubResource](#subresource): Gets or sets url path map resource of application gateway
...
### Properties
* **defaultBackendAddressPool**: [SubResource](#subresource): Gets or sets default backend address pool resource of URL path map
* **defaultBackendHttpSettings**: [SubResource](#subresource): Gets or sets default backend http settings resource of URL path map
...
### Properties
* **backendIPConfiguration**: [NetworkInterfaceIPConfiguration](#networkinterfaceipconfiguration): Gets or sets a reference to a private ip address defined on a NetworkInterface of a VM. Traffic sent to frontendPort of each of the frontendIPConfigurations is forwarded to the backed IP
