...
```bicep
resource exampleResource 'Microsoft.ProviderHub/providerMonitorSettings@2025-10-01' = {
  name: 'example'
  location: 'eastus'
}
```
...
```bicep
resource exampleResource 'Microsoft.ProviderHub/providerRegistrations@2025-10-01' = {
  name: 'example'
  kind: 'Direct'
  properties: {
    capabilities: [
...
```bicep
resource exampleResource 'Microsoft.ProviderHub/providerRegistrations/authorizedApplications@2025-10-01' = {
...
```bicep
resource exampleResource 'Microsoft.ProviderHub/providerRegistrations/customRollouts@2025-10-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    specification: {
...
```bicep
resource exampleResource 'Microsoft.ProviderHub/providerRegistrations/defaultRollouts@2025-10-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    specification: {
...
```bicep
resource exampleResource 'Microsoft.ProviderHub/providerRegistrations/manifests@2025-10-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ProviderHub/providerRegistrations/notificationRegistrations@2025-10-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    includedEvents: [
...
```bicep
resource exampleResource 'Microsoft.ProviderHub/providerRegistrations/resourcetypeRegistrations@2025-10-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.ProviderHub/providerRegistrations/resourcetypeRegistrations/resourcetypeRegistrations/resourcetypeRegistrations/resourcetypeRegistrations/skus@2025-10-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    skuSettings: [
...
```bicep
resource exampleResource 'Microsoft.ProviderHub/providerRegistrations/resourcetypeRegistrations/resourcetypeRegistrations/resourcetypeRegistrations/skus@2025-10-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    skuSettings: [
...
```bicep
resource exampleResource 'Microsoft.ProviderHub/providerRegistrations/resourcetypeRegistrations/resourcetypeRegistrations/skus@2025-10-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    skuSettings: [
...
Skus_CreateOrUpdate
```bicep
resource exampleResource 'Microsoft.ProviderHub/providerRegistrations/resourcetypeRegistrations/skus@2025-10-01' = {
  parent: parentResource 
  name: 'example'
  properties: {
    skuSettings: [
