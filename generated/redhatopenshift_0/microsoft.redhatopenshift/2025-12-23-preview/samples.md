...
```bicep
resource exampleResource 'Microsoft.RedHatOpenShift/hcpOpenShiftClusters@2025-12-23-preview' = {
  name: 'example'
  identity: {
    type: 'UserAssigned'
  ...
  properties: {
    ...
    imageDigestMirrors: [
      {
        mirrors: [
          'mirror1.example.com/image1'
          'mirror2.example.com/image1'
        ]
        source: 'registry.example.com/image1'
      }
      {
        mirrors: [
          'mirror1.example.com/image2'
        ]
        source: 'registry.example.com/image2'
      }
    ]
    network: {
      hostPrefix: 21
...
```bicep
resource exampleResource 'Microsoft.RedHatOpenShift/hcpOpenShiftClusters/externalAuths@2025-12-23-preview' = {
...
```bicep
resource exampleResource 'Microsoft.RedHatOpenShift/hcpOpenShiftClusters/nodePools@2025-12-23-preview' = {
  parent: parentResource 
  name: 'example'
