...
```bicep
resource exampleResource 'Microsoft.RedHatOpenShift/hcpOpenShiftClusters@2026-06-30-preview' = {
  name: 'example'
  identity: {
    type: 'UserAssigned'
...
```bicep
resource exampleResource 'Microsoft.RedHatOpenShift/hcpOpenShiftClusters/externalAuths@2026-06-30-preview' = {
...
```bicep
resource exampleResource 'Microsoft.RedHatOpenShift/hcpOpenShiftClusters/nodePools@2026-06-30-preview' = {
  parent: parentResource 
  name: 'example'
