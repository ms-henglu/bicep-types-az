...
* **exportPolicy**: [ExportPolicyRule](#exportpolicyrule)[]: Set of export policy rules
...
* **protocolTypes**: ('NFSv3' | 'NFSv4' | 'SMB' | string)[]: Set of protocol types, default NFSv3, CIFS for SMB protocol
