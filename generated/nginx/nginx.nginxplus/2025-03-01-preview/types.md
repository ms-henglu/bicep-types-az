...
* **package**: [NginxConfigurationPackage](#nginxconfigurationpackage): Configuration package details.
* **protectedFiles**: [NginxConfigurationProtectedFileContent](#nginxconfigurationprotectedfilecontent)[]: List of protected files.
* **rootFile**: string: The root file of the NGINX config file(s). It must match one of the files' filepath.

## AnalysisCreate
### Properties
* **config**: [AnalysisConfig](#analysisconfig) (Required): Configuration details for analysis.

## AnalysisDiagnostic
### Properties
* **description**: string (Required): Description of the error.
* **directive**: string (Required): The directive being analyzed.
* **file**: string (Required): The filepath of the most relevant config file.
* **id**: string: Unique identifier for the error.
* **line**: int (Required): Line number where the error was found.
* **message**: string (Required): Error message.
* **rule**: string (Required): Rule that triggered the error.

## AnalysisResult
### Properties
* **data**: [AnalysisResultContent](#analysisresultcontent): Analysis result data.
* **status**: string (Required): The status of the analysis.

## AnalysisResultContent
### Properties
* **diagnostics**: [DiagnosticItem](#diagnosticitem)[]: List of diagnostics found during analysis.
* **errors**: [AnalysisDiagnostic](#analysisdiagnostic)[]: List of errors found during analysis.
...
## DiagnosticItem
### Properties
* **category**: string: Category of warning like Best-practices, Recommendation, Security etc. Can be any free form text.
* **description**: string (Required): Description of the diagnostic.
* **directive**: string (Required): The directive being analyzed. This is a free form text that can be used to identify the directive.
* **file**: string (Required): The filepath of the most relevant config file.
* **id**: string: Unique identifier for the diagnostic error type. Generated by the analyzer as a free form text.
* **level**: 'Info' | 'Warning' | string (Required): Warning or Info.
* **line**: int (Required): Line number where the diagnostic was found.
* **message**: string (Required): Diagnostic message.
* **rule**: string (Required): Rule that triggered the diagnostic. Rule names can be any free form text that can be used to identify.
...
### Properties
* **content**: string: File content in Nginx configuration format, UTF-8 encoded.
