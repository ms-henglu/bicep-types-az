...
## Resource PureStorage.Block/storagePools/avsStorageContainers@2026-05-01-preview
* **Readable Scope(s)**: ResourceGroup
...
## Resource PureStorage.Block/storagePools/avsStorageContainers/volumes@2026-05-01-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource PureStorage.Block/storagePools/avsVms@2026-05-01-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource PureStorage.Block/storagePools/avsVms/avsVmVolumes@2026-05-01-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource PureStorage.Block/storagePools/recoverableVolumeGroups@2026-05-01-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Function configurePlatformConsoleAuth (PureStorage.Block/storagePools@2026-05-01-preview)
...
## Function getAvsStatus (PureStorage.Block/storagePools@2026-05-01-preview)
* **Resource**: PureStorage.Block/storagePools
* **ApiVersion**: 2026-05-01-preview
* **Output**: [AvsStatus](#avsstatus)

## Function getBillingReport (PureStorage.Block/reservations@2026-05-01-preview)
* **Resource**: PureStorage.Block/reservations
* **ApiVersion**: 2026-05-01-preview
* **Output**: [ReservationBillingUsageReport](#reservationbillingusagereport)

## Function getBillingStatus (PureStorage.Block/reservations@2026-05-01-preview)
* **Resource**: PureStorage.Block/reservations
* **ApiVersion**: 2026-05-01-preview
* **Output**: [ReservationBillingStatus](#reservationbillingstatus)

## Function getHealthStatus (PureStorage.Block/storagePools@2026-05-01-preview)
* **Resource**: PureStorage.Block/storagePools
* **ApiVersion**: 2026-05-01-preview
* **Output**: [HealthResponse](#healthresponse)

## Function getResourceLimits (PureStorage.Block/reservations@2026-05-01-preview)
* **Resource**: PureStorage.Block/reservations
* **ApiVersion**: 2026-05-01-preview
* **Output**: [LimitDetails](#limitdetails)

## Function getStatus (PureStorage.Block/storagePools/volumeGroups@2026-05-01-preview)
* **Resource**: PureStorage.Block/storagePools/volumeGroups
* **ApiVersion**: 2026-05-01-preview
* **Output**: [VolumeGroupStatus](#volumegroupstatus)

## Function latestLinkedSaaS (PureStorage.Block/reservations@2026-05-01-preview)
* **Resource**: PureStorage.Block/reservations
* **ApiVersion**: 2026-05-01-preview
* **Output**: [LatestLinkedSaaSResponse](#latestlinkedsaasresponse)

## Function linkSaaS (PureStorage.Block/reservations@2026-05-01-preview)
* **Resource**: PureStorage.Block/reservations
* **ApiVersion**: 2026-05-01-preview
...
#### Properties
* **authType**: 'ssh' (Required): Authentication type discriminator
* **publicKey**: string (Required): SSH public key in OpenSSH authorized_keys format
* **role**: 'array_admin' | 'read_only' | 'storage_admin' | string (Required): Role to assign to the user on the platform console
* **username**: string (Required): Username to associate with the SSH public key
...
#### Properties
* **authType**: 'ssh' (Required): Authentication type discriminator
* **role**: 'array_admin' | 'read_only' | 'storage_admin' | string (Required): Role assigned to the user on the platform console
* **username**: string (Required): Username that was configured for the console session
