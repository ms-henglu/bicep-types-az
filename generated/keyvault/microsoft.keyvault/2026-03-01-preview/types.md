# Microsoft.KeyVault @ 2026-03-01-preview

## Resource Microsoft.KeyVault/locations/deletedManagedHSMs@2026-03-01-preview
...
## Resource Microsoft.KeyVault/locations/deletedVaults@2026-03-01-preview
* **Readable Scope(s)**: Subscription
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2026-03-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.KeyVault/managedHSMs@2026-03-01-preview
...
## Resource Microsoft.KeyVault/managedHSMs/keys@2026-03-01-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.KeyVault/managedHSMs/keys/versions@2026-03-01-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2026-03-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.KeyVault/managedHSMs/privateEndpointConnections@2026-03-01-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.KeyVault/vaults@2026-03-01-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.KeyVault/vaults/accessPolicies@2026-03-01-preview
...
## Resource Microsoft.KeyVault/vaults/keys@2026-03-01-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.KeyVault/vaults/keys/versions@2026-03-01-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2026-03-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.KeyVault/vaults/privateEndpointConnections@2026-03-01-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.KeyVault/vaults/secrets@2026-03-01-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Function purge (Microsoft.KeyVault/locations/deletedManagedHSMs@2026-03-01-preview)
* **Resource**: Microsoft.KeyVault/locations/deletedManagedHSMs
* **ApiVersion**: 2026-03-01-preview

## Function purge (Microsoft.KeyVault/locations/deletedVaults@2026-03-01-preview)
...
* **serviceTags**: [MhsmServiceTagRule](#mhsmservicetagrule)[]: The list of service tags.
...
## MhsmServiceTagRule
### Properties
* **tag**: string (Required): Name of the service tag.
...
### Properties
* **minimumTokenBindingStrength**: 'AttestedConfidential' | 'AttestedTrustedLaunch' | 'NoValidation' | 'Unattested' | string: Must be one of the following values "NoValidation", "Unattested", "AttestedTrustedLaunch", "AttestedConfidential". Strength of the token binding increases with each value in that order.
* **mode**: 'Enforced' | 'NotEnforced' | string: This specifies whether token binding is disabled, enabled or enforced.
...
* **tenantId**: string {minLength: 36, maxLength: 36, pattern: "^[0-9a-fA-F]{8}-([0-9a-fA-F]{4}-){3}[0-9a-fA-F]{12}$"} (Required): The Azure Active Directory tenant ID that should be used for authenticating requests to the key vault.
* **tokenBindingParameters**: [TokenBindingParameters](#tokenbindingparameters): Configuration for Token Binding for Entra tokens
