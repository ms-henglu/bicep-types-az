...
DPSCreate
```bicep
resource exampleResource 'Microsoft.Devices/provisioningServices@2026-08-31' = {
  name: 'example'
  location: 'East US'
  properties: {
...
```bicep
resource exampleResource 'Microsoft.Devices/provisioningServices/certificates@2026-08-31' = {
...
```bicep
resource exampleResource 'Microsoft.Devices/provisioningServices/privateEndpointConnections@2026-08-31' = {
  parent: parentResource 
  name: 'example'
  properties: {
