...
* **signalKind**: 'AzureResourceMetric' | 'LogAnalyticsQuery' | 'PrometheusMetricsQuery' | string (Required): Kind of the signal instance
...
* **expiresIn**: int {minValue: 1, maxValue: 10080}: Number of minutes until the health report expires. Defaults to 60 (1 hour) if not specified.
