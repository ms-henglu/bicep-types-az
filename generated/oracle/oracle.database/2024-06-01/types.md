...
## Function generateWallet (Oracle.Database/autonomousDatabases@2024-06-01)
* **Resource**: Oracle.Database/autonomousDatabases
* **ApiVersion**: 2024-06-01
...
## Function removeVms (Oracle.Database/cloudVmClusters@2024-06-01)
* **Resource**: Oracle.Database/cloudVmClusters
* **ApiVersion**: 2024-06-01
* **Input**: [AddRemoveDbNode](#addremovedbnode)
* **Output**: [CloudVmCluster](#cloudvmcluster)

## Function restore (Oracle.Database/autonomousDatabases@2024-06-01)
* **Resource**: Oracle.Database/autonomousDatabases
* **ApiVersion**: 2024-06-01
* **Input**: [RestoreAutonomousDatabaseDetails](#restoreautonomousdatabasedetails)
* **Output**: [AutonomousDatabase](#autonomousdatabase)

## Function shrink (Oracle.Database/autonomousDatabases@2024-06-01)
* **Resource**: Oracle.Database/autonomousDatabases
* **ApiVersion**: 2024-06-01
* **Output**: [AutonomousDatabase](#autonomousdatabase)

## Function switchover (Oracle.Database/autonomousDatabases@2024-06-01)
* **Resource**: Oracle.Database/autonomousDatabases
* **ApiVersion**: 2024-06-01
* **Input**: [PeerDbDetails](#peerdbdetails)
* **Output**: [AutonomousDatabase](#autonomousdatabase)
