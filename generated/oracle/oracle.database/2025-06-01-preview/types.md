...
## Resource Oracle.Database/cloudExadataInfrastructures/dbServers@2025-06-01-preview
* **Readable Scope(s)**: ResourceGroup
...
## Resource Oracle.Database/locations/autonomousDbVersions@2025-06-01-preview
* **Readable Scope(s)**: Subscription
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2025-06-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Oracle.Database/locations/systemVersions@2025-06-01-preview
* **Readable Scope(s)**: Subscription
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2025-06-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Function action (Oracle.Database/autonomousDatabases@2025-06-01-preview)
...
## Function action (Oracle.Database/cloudVmClusters/dbNodes@2025-06-01-preview)
* **Resource**: Oracle.Database/cloudVmClusters/dbNodes
* **ApiVersion**: 2025-06-01-preview
* **Input**: [DbNodeAction](#dbnodeaction)
* **Output**: [DbNode](#dbnode)

## Function action (Oracle.Database/exadbVmClusters/dbNodes@2025-06-01-preview)
* **Resource**: Oracle.Database/exadbVmClusters/dbNodes
* **ApiVersion**: 2025-06-01-preview
* **Input**: [DbNodeAction](#dbnodeaction)
* **Output**: [DbActionResponse](#dbactionresponse)

## Function addAzureSubscriptions (Oracle.Database/oracleSubscriptions@2025-06-01-preview)
* **Resource**: Oracle.Database/oracleSubscriptions
* **ApiVersion**: 2025-06-01-preview
* **Input**: [AzureSubscriptions](#azuresubscriptions)

## Function addStorageCapacity (Oracle.Database/cloudExadataInfrastructures@2025-06-01-preview)
* **Resource**: Oracle.Database/cloudExadataInfrastructures
* **ApiVersion**: 2025-06-01-preview
* **Output**: [CloudExadataInfrastructure](#cloudexadatainfrastructure)

## Function addVms (Oracle.Database/cloudVmClusters@2025-06-01-preview)
* **Resource**: Oracle.Database/cloudVmClusters
* **ApiVersion**: 2025-06-01-preview
* **Input**: [AddRemoveDbNode](#addremovedbnode)
* **Output**: [CloudVmCluster](#cloudvmcluster)

## Function changeDisasterRecoveryConfiguration (Oracle.Database/autonomousDatabases@2025-06-01-preview)
* **Resource**: Oracle.Database/autonomousDatabases
* **ApiVersion**: 2025-06-01-preview
* **Input**: [DisasterRecoveryConfigurationDetails](#disasterrecoveryconfigurationdetails)
* **Output**: [AutonomousDatabase](#autonomousdatabase)

## Function failover (Oracle.Database/autonomousDatabases@2025-06-01-preview)
* **Resource**: Oracle.Database/autonomousDatabases
* **ApiVersion**: 2025-06-01-preview
* **Input**: [PeerDbDetails](#peerdbdetails)
* **Output**: [AutonomousDatabase](#autonomousdatabase)

## Function generateWallet (Oracle.Database/autonomousDatabases@2025-06-01-preview)
* **Resource**: Oracle.Database/autonomousDatabases
* **ApiVersion**: 2025-06-01-preview
...
## Function removeVms (Oracle.Database/cloudVmClusters@2025-06-01-preview)
* **Resource**: Oracle.Database/cloudVmClusters
* **ApiVersion**: 2025-06-01-preview
* **Input**: [AddRemoveDbNode](#addremovedbnode)
* **Output**: [CloudVmCluster](#cloudvmcluster)

## Function removeVms (Oracle.Database/exadbVmClusters@2025-06-01-preview)
...
## Function restore (Oracle.Database/autonomousDatabases@2025-06-01-preview)
* **Resource**: Oracle.Database/autonomousDatabases
* **ApiVersion**: 2025-06-01-preview
* **Input**: [RestoreAutonomousDatabaseDetails](#restoreautonomousdatabasedetails)
* **Output**: [AutonomousDatabase](#autonomousdatabase)

## Function shrink (Oracle.Database/autonomousDatabases@2025-06-01-preview)
* **Resource**: Oracle.Database/autonomousDatabases
* **ApiVersion**: 2025-06-01-preview
* **Output**: [AutonomousDatabase](#autonomousdatabase)

## Function switchover (Oracle.Database/autonomousDatabases@2025-06-01-preview)
* **Resource**: Oracle.Database/autonomousDatabases
* **ApiVersion**: 2025-06-01-preview
* **Input**: [PeerDbDetails](#peerdbdetails)
* **Output**: [AutonomousDatabase](#autonomousdatabase)
